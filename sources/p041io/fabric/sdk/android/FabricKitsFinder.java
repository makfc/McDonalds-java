...
class FabricKitsFinder implements Callable<Map<String, KitInfo>> {
    ...
    public Map<String, KitInfo> call() throws Exception {
        ...
        Fabric.getLogger().mo34410v("Fabric", "finish scanning in " + (SystemClock.elapsedRealtime() - startScan));
        return kitInfos;
    }
    ...
    private Map<String, KitInfo> findImplicitKits() {
        ...
        try {
            ...
            Fabric.getLogger().mo34410v("Fabric", "Found kit: com.google.firebase.firebase-ads");
        } catch (Exception e) {
        }
        return implicitKits;
    }
        ...
        while (entries.hasMoreElements()) {
            ...
            if (entry.getName().startsWith("fabric/") && entry.getName().length() > "fabric/".length()) {
                ...
                if (kitInfo != null) {
                    ...
                    Fabric.getLogger().mo34410v("Fabric", String.format("Found kit:[%s] version:[%s]", new Object[]{kitInfo.getIdentifier(), kitInfo.getVersion()}));
                }
            }
        }
        if (apkFile != null) {
    ...
    private KitInfo loadKitInfo(ZipEntry fabricFile, ZipFile apk) {
        ...
        try {
            ...
            kitInfo.mo34406e("Fabric", "Error when parsing fabric properties " + fabricFile.getName(), ie);
            return null;
        } finally {
