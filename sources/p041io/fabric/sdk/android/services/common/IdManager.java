    ...
    public IdManager(Context appContext, String appIdentifier, String appInstallIdentifier, Collection<Kit> kits) {
        if (appContext == null) {
            ...
            if (!this.collectHardwareIds) {
                Fabric.getLogger().mo34403d("Fabric", "Device ID collection disabled for " + appContext.getPackageName());
            }
            ...
            if (!this.collectUserIds) {
                Fabric.getLogger().mo34403d("Fabric", "User information collection disabled for " + appContext.getPackageName());
            }
        }
    }
