...
class AdvertisingInfoServiceStrategy implements AdvertisingInfoStrategy {
    ...
    private static final class AdvertisingConnection implements ServiceConnection {
        ...
        public IBinder getBinder() {
            if (this.retrieved) {
                Fabric.getLogger().mo34405e("Fabric", "getBinder already called");
            }
            this.retrieved = true;
            try {
    ...
    private static final class AdvertisingInterface implements IInterface {
        ...
        public String getId() throws RemoteException {
            ...
            try {
                ...
                Fabric.getLogger().mo34403d("Fabric", "Could not get parcel from Google Play Service to capture AdvertisingId");
            } finally {
                reply.recycle();
                data.recycle();
            }
        ...
        public boolean isLimitAdTrackingEnabled() throws RemoteException {
            ...
            try {
                ...
                Fabric.getLogger().mo34403d("Fabric", "Could not get parcel from Google Play Service to capture Advertising limitAdTracking");
                reply.recycle();
                data.recycle();
            } catch (Throwable th) {
                reply.recycle();
    ...
    public AdvertisingInfo getAdvertisingInfo() {
        if (Looper.myLooper() == Looper.getMainLooper()) {
            Fabric.getLogger().mo34403d("Fabric", "AdvertisingInfoServiceStrategy cannot be called on the main thread");
            return null;
        }
        try {
            ...
            try {
                ...
                Fabric.getLogger().mo34403d("Fabric", "Could not bind to Google Play Service to capture AdvertisingId");
                return null;
            } catch (Exception e) {
                Fabric.getLogger().mo34412w("Fabric", "Exception in binding to Google Play Service to capture AdvertisingId", e);
                this.context.unbindService(connection);
                return null;
            } catch (Throwable t) {
                Fabric.getLogger().mo34404d("Fabric", "Could not bind to Google Play Service to capture AdvertisingId", t);
                return null;
            }
        } catch (NameNotFoundException e2) {
            Fabric.getLogger().mo34403d("Fabric", "Unable to find Google Play Services package name");
            return null;
        } catch (Exception e3) {
            Fabric.getLogger().mo34404d("Fabric", "Unable to determine if Google Play Services is available", e3);
            return null;
        }
    }
}
