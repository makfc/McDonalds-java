...
public class QueueFile implements Closeable {
    ...
    private final class ElementInputStream extends InputStream {
        ...
        /* synthetic */ ElementInputStream(QueueFile x0, Element x1, C45981 x2) {
            this(x1);
        }
    ...
    private static void initialize(File file) throws IOException {
        ...
        RandomAccessFile raf = QueueFile.open(tempFile);
        try {
    ...
    public synchronized void forEach(ElementReader reader) throws IOException {
        ...
        for (int i = 0; i < this.elementCount; i++) {
            ...
            reader.read(new ElementInputStream(this, current, null), current.length);
