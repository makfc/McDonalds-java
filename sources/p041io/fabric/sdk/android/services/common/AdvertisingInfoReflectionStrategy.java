...
class AdvertisingInfoReflectionStrategy implements AdvertisingInfoStrategy {
    ...
    private String getAdvertisingId() {
        try {
            ...
            Fabric.getLogger().mo34411w("Fabric", "Could not call getId on com.google.android.gms.ads.identifier.AdvertisingIdClient$Info");
            return null;
        }
    }
    ...
    private boolean isLimitAdTrackingEnabled() {
        try {
            ...
            Fabric.getLogger().mo34411w("Fabric", "Could not call isLimitAdTrackingEnabled on com.google.android.gms.ads.identifier.AdvertisingIdClient$Info");
            return false;
        }
    }
    ...
    private Object getInfo() {
        ...
        try {
            ...
            Fabric.getLogger().mo34411w("Fabric", "Could not call getAdvertisingIdInfo on com.google.android.gms.ads.identifier.AdvertisingIdClient");
            return obj;
        }
    }
}
