...
public class AppLinkNavigation {
    ...
    static class C04371 implements Continuation<AppLink, NavigationResult> {
    ...
    private Bundle buildAppLinkDataForNavigation(Context context) {
        ...
        if (context != null) {
            ...
            if (appInfo != null) {
                ...
                if (refererAppName != null) {
                    refererAppLinkData.putString(NativeProtocol.BRIDGE_ARG_APP_NAME_STRING, refererAppName);
                }
            }
        }
        ...
        data.putString("user_agent", "Bolts Android 1.1.4");
        data.putBundle("referer_app_link", refererAppLinkData);
        ...
        if (eligibleTargetIntent != null) {
            ...
            if (webUrl != null) {
                try {
                    ...
                    outIntent = new Intent("android.intent.action.VIEW", webUrl.buildUpon().appendQueryParameter("al_applink_data", !(appLinkDataJson instanceof JSONObject) ? appLinkDataJson.toString() : JSONObjectInstrumentation.toString(appLinkDataJson)).build());
    ...
    private void sendAppLinkNavigateEventBroadcast(Context context, Intent intent, NavigationResult type, JSONException e) {
        ...
        extraLoggingData.put(Response.SUCCESS_KEY, type.isSucceeded() ? "1" : "0");
