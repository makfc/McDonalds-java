...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        boolean lctFlag;
        boolean z = true;
        this.header.currentFrame.f5571ix = readShort();
        this.header.currentFrame.f5572iy = readShort();
        this.header.currentFrame.f5570iw = readShort();
        this.header.currentFrame.f5569ih = readShort();
        int packed = read();
        if ((packed & 128) != 0) {
            lctFlag = true;
        } else {
    ...
    private int[] readColorTable(int ncolors) {
        ...
        try {
            ...
            while (i < ncolors) {
                ...
                j2 = j + 1;
                int i2 = i + 1;
                tab[i] = ((ViewCompat.MEASURED_STATE_MASK | (r << 16)) | (g << 8)) | (c[j] & 255);
                j = j2;
                i = i2;
            }
