...
public final class Util {
    ...
    private static int getBytesPerPixel(Config config) {
        ...
        switch (C16161.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()]) {
            case 1:
                return 1;
            case 2:
            case 3:
    ...
    private static boolean isValidDimension(int dimen) {
        return dimen > 0 || dimen == ExploreByTouchHelper.INVALID_ID;
    }
