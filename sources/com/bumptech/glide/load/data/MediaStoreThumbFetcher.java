...
public class MediaStoreThumbFetcher implements DataFetcher<InputStream> {
    ...
    static class ImageThumbnailQuery implements ThumbnailQuery {
        ...
        public Cursor queryPath(Context context, Uri uri) {
            ...
            return context.getContentResolver().query(Thumbnails.EXTERNAL_CONTENT_URI, PATH_PROJECTION, "kind = 1 AND image_id = ?", new String[]{imageId}, null);
        }
    }
    ...
    static class VideoThumbnailQuery implements ThumbnailQuery {
        ...
        public Cursor queryPath(Context context, Uri uri) {
            ...
            return context.getContentResolver().query(Video.Thumbnails.EXTERNAL_CONTENT_URI, PATH_PROJECTION, "kind = 1 AND video_id = ?", new String[]{videoId}, null);
        }
    }
