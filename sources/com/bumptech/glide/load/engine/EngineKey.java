...
class EngineKey implements Key {
    ...
    public Key getOriginalKey() {
        if (this.originalKey == null) {
            this.originalKey = new OriginalKey(this.f5576id, this.signature);
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!this.f5576id.equals(engineKey.f5576id) || !this.signature.equals(engineKey.signature) || this.height != engineKey.height || this.width != engineKey.width) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        if (this.hashCode == 0) {
            int hashCode;
            this.hashCode = this.f5576id.hashCode();
    ...
    public String toString() {
        if (this.stringKey == null) {
            String id;
            StringBuilder append = new StringBuilder().append("EngineKey{").append(this.f5576id).append('+').append(this.signature).append("+[").append(this.width).append('x').append(this.height).append("]+").append('\'');
            if (this.cacheDecoder != null) {
    ...
    public void updateDiskCacheKey(MessageDigest messageDigest) throws UnsupportedEncodingException {
        ...
        messageDigest.update(this.f5576id.getBytes(Utf8Charset.NAME));
        messageDigest.update(dimensions);
        messageDigest.update((this.cacheDecoder != null ? this.cacheDecoder.getId() : "").getBytes(Utf8Charset.NAME));
        messageDigest.update((this.decoder != null ? this.decoder.getId() : "").getBytes(Utf8Charset.NAME));
        messageDigest.update((this.transformation != null ? this.transformation.getId() : "").getBytes(Utf8Charset.NAME));
        messageDigest.update((this.encoder != null ? this.encoder.getId() : "").getBytes(Utf8Charset.NAME));
        messageDigest.update((this.sourceEncoder != null ? this.sourceEncoder.getId() : "").getBytes(Utf8Charset.NAME));
    }
}
