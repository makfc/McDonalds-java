...
public class Convert {
    ...
    public static byte[] get1BString(String str) {
        try {
            ...
            byteArrayOutputStream.write(new byte[]{(byte) str.getBytes(Utf8Charset.NAME).length});
    ...
    public static void convert1bString(byte[] bArr, int i, C1275b c1275b) {
        try {
            c1275b.f4565a = bArr[i];
            c1275b.f4566b = new String(bArr, i + 1, c1275b.f4565a, Utf8Charset.NAME);
        } catch (Exception e) {
            e.printStackTrace();
            c1275b.f4565a = 0;
            c1275b.f4566b = "";
    ...
    public static void convert2bString(byte[] bArr, int i, C1275b c1275b) {
        try {
            c1275b.f4565a = getShort(bArr, i);
            c1275b.f4566b = new String(bArr, i + 2, c1275b.f4565a, Utf8Charset.NAME);
        } catch (Exception e) {
            e.printStackTrace();
            c1275b.f4565a = 0;
            c1275b.f4566b = "";
