...
public class ResUtil {
    public static Bitmap decodeBitmapWithAdaptiveSize(Context context, int i) {
        ...
        Bitmap decodeResource = BitmapFactoryInstrumentation.decodeResource(context.getResources(), i, options);
    ...
    public static Bitmap decodeAssetBitmap(Context context, String str) {
        ...
        try {
            ...
            decodeStream = BitmapFactoryInstrumentation.decodeStream(open);
            try {
