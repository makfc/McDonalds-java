    ...
    public String getGridParmaV4() {
        ...
        while (i < this.mapTiles.size()) {
            ...
            if (gridName == null || gridName.length() == 0 || containllegal(gridName)) {
                ...
                str = str3 == null ? str + str2 : str3 + str + str2;
            } else {
                str = str3;
            }
            i++;
        ...
        if (str3.length() > 0) {
            str = str3;
            while (str != null && (str.endsWith(str2) || str.endsWith(" "))) {
        ...
        if (i4 + b <= bArr.length && i4 <= bArr.length - 1 && b >= (byte) 0) {
            ...
            if (this.mGLMapEngine.isMapEngineValid()) {
                ...
                if (i2 > i) {
                    ...
                    C1278f putData = instance.putData(bArr2);
                    int i5 = !this.mMapCallback.isGridInScreen(this.datasource, str) ? 1 : 0;
                    if (putData != null) {
                        this.mGLMapEngine.putMapData(putData.f4577a, 0, putData.f4577a.length, this.datasource, putData.f4579c);
                    }
                    if (i5 != 0) {
                        doCancel();
                    }
