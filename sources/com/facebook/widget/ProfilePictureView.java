...
public class ProfilePictureView extends FrameLayout {
    ...
    /* renamed from: com.facebook.widget.ProfilePictureView$1 */
    class C20551 implements Callback {
        C20551() {
        }
    ...
    private void parseAttributes(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, C1926R.styleable.com_facebook_profile_picture_view);
        setPresetSize(a.getInt(C1926R.styleable.com_facebook_profile_picture_view_preset_size, -1));
        this.isCropped = a.getBoolean(C1926R.styleable.com_facebook_profile_picture_view_is_cropped, true);
        a.recycle();
    }
    ...
    private void setBlankProfilePicture() {
        if (this.customizedDefaultProfilePicture == null) {
            setImageBitmap(BitmapFactoryInstrumentation.decodeResource(getResources(), isCropped() ? C1926R.C1924drawable.com_facebook_profile_picture_blank_square : C1926R.C1924drawable.com_facebook_profile_picture_blank_portrait));
            return;
        }
    ...
    private void sendImageRequest(boolean allowCachedResponse) {
        try {
            ImageRequest request = new Builder(getContext(), ImageRequest.getProfilePictureUrl(this.profileId, this.queryWidth, this.queryHeight)).setAllowCachedRedirects(allowCachedResponse).setCallerTag(this).setCallback(new C20551()).build();
    ...
    private int getPresetSizeInPixels(boolean forcePreset) {
        ...
        switch (this.presetSizeType) {
            case LARGE /*-4*/:
                dimensionId = C1926R.dimen.com_facebook_profilepictureview_preset_size_large;
                break;
            case NORMAL /*-3*/:
                dimensionId = C1926R.dimen.com_facebook_profilepictureview_preset_size_normal;
                break;
            case -2:
                dimensionId = C1926R.dimen.com_facebook_profilepictureview_preset_size_small;
                break;
            case -1:
                if (forcePreset) {
                    dimensionId = C1926R.dimen.com_facebook_profilepictureview_preset_size_normal;
