...
public final class HighLevelEncoder {
    ...
    private static boolean isNativeC40(char ch) {
        return ch == SafeJsonPrimitive.NULL_CHAR || ((ch >= '0' && ch <= '9') || (ch >= 'A' && ch <= 'Z'));
    }
    ...
    private static boolean isNativeX12(char ch) {
        return isX12TermSep(ch) || ch == SafeJsonPrimitive.NULL_CHAR || ((ch >= '0' && ch <= '9') || (ch >= 'A' && ch <= 'Z'));
    }
    ...
    private static boolean isNativeEDIFACT(char ch) {
        return ch >= SafeJsonPrimitive.NULL_CHAR && ch <= '^';
    }
