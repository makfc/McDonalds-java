...
public final class BizcardResultParser extends AbstractDoCoMoResultParser {
    public AddressBookParsedResult parse(Result result) {
        ...
        return new AddressBookParsedResult(ResultParser.maybeWrap(fullName), null, null, buildPhoneNumbers(AbstractDoCoMoResultParser.matchSingleDoCoMoPrefixedField("B:", rawText, true), AbstractDoCoMoResultParser.matchSingleDoCoMoPrefixedField("M:", rawText, true), AbstractDoCoMoResultParser.matchSingleDoCoMoPrefixedField("F:", rawText, true)), null, ResultParser.maybeWrap(AbstractDoCoMoResultParser.matchSingleDoCoMoPrefixedField("E:", rawText, true)), null, null, null, AbstractDoCoMoResultParser.matchDoCoMoPrefixedField("A:", rawText, true), null, org, null, title, null, null);
    }
    ...
    private static String buildName(String firstName, String lastName) {
        ...
        return lastName == null ? firstName : firstName + SafeJsonPrimitive.NULL_CHAR + lastName;
    }
}
