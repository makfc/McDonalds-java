            ...
            if (ai != null) {
                ...
                switch (ai.hashCode()) {
                    ...
                    case 1567:
                        ...
                        break;
                    case 1568:
                        if (ai.equals(DCSSubscription.ID_MOBILE_NOTIFICATION)) {
                            obj = 3;
                            break;
                        }
                        break;
                    case 1570:
                        if (ai.equals(DCSPreference.ID_FOOD_PREFERENCE_SANDWICH)) {
                            obj = 4;
                            break;
                        }
                        break;
                    case 1572:
                        if (ai.equals(DCSPreference.ID_FOOD_PREFERENCE_DRINK)) {
                            obj = 5;
                            break;
                        }
                        break;
                    case 1574:
                        if (ai.equals(DCSPreference.ID_FOOD_PREFERENCE_HAPPYMEAL)) {
                            obj = 6;
                            break;
                        }
                        break;
