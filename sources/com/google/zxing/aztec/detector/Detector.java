...
public final class Detector {
    ...
    static final class Point {
        /* renamed from: x */
        private final int f6525x;
        /* renamed from: y */
        private final int f6526y;
        ...
        public String toString() {
            return "<" + this.f6525x + SafeJsonPrimitive.NULL_CHAR + this.f6526y + '>';
        }
    }
    ...
    private void extractParameters(ResultPoint[] bullsEyeCorners) throws NotFoundException {
        if (isValid(bullsEyeCorners[0]) && isValid(bullsEyeCorners[1]) && isValid(bullsEyeCorners[2]) && isValid(bullsEyeCorners[3])) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                if (this.compact) {
                    j = parameterData << 7;
                    i2 = (side >> 1) & TransportMediator.KEYCODE_MEDIA_PAUSE;
                } else {
                    j = parameterData << 10;
                    i2 = ((side >> 2) & 992) + ((side >> 1) & 31);
                }
                parameterData = j + ((long) i2);
            }
