...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C28111();
    ...
    static class C28111 implements Comparator<Comparable> {
        C28111() {
        }
    ...
    private abstract class LinkedTreeMapIterator<T> implements Iterator<T> {
        ...
        /* synthetic */ LinkedTreeMapIterator(LinkedHashTreeMap x0, C28111 x1) {
            this();
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C28121 extends LinkedTreeMapIterator<Entry<K, V>> {
            C28121() {
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C28131 extends LinkedTreeMapIterator<K> {
            C28131() {
                super(LinkedHashTreeMap.this, null);
            }
