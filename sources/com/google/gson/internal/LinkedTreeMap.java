...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C28141();
    ...
    static class C28141 implements Comparator<Comparable> {
        C28141() {
        }
    ...
    private abstract class LinkedTreeMapIterator<T> implements Iterator<T> {
        ...
        /* synthetic */ LinkedTreeMapIterator(LinkedTreeMap x0, C28141 x1) {
            this();
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C28151 extends LinkedTreeMapIterator<Entry<K, V>> {
            C28151() {
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C28161 extends LinkedTreeMapIterator<K> {
            C28161() {
                super(LinkedTreeMap.this, null);
            }
