...
public class JsonReader implements Closeable {
    ...
    static class C28251 extends JsonReaderInternalAccess {
        C28251() {
        }
    ...
    static {
        JsonReaderInternalAccess.INSTANCE = new C28251();
    }
    ...
    private boolean fillBuffer(int minimum) throws IOException {
        ...
        this.pos = 0;
        do {
            int total = this.f6522in.read(buffer, this.limit, buffer.length - this.limit);
            if (total == -1) {
                return false;
            }
            this.limit += total;
