...
public interface IStreetViewPanoramaFragmentDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IStreetViewPanoramaFragmentDelegate {
        ...
        private static class zza implements IStreetViewPanoramaFragmentDelegate {
            ...
            public IStreetViewPanoramaDelegate getStreetViewPanorama() throws RemoteException {
                ...
                try {
                    ...
                    IStreetViewPanoramaDelegate zzdh = com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate.zza.zzdh(obtain2.readStrongBinder());
                    return zzdh;
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void getStreetViewPanoramaAsync(zzaa zzaa) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
            ...
            public zzd onCreateView(zzd zzd, zzd zzd2, Bundle bundle) throws RemoteException {
            ...
            public void onInflate(zzd zzd, StreetViewPanoramaOptions streetViewPanoramaOptions, Bundle bundle) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
        ...
        public static IStreetViewPanoramaFragmentDelegate zzdi(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 2:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                    onInflate(com.google.android.gms.dynamic.zzd.zza.zzbz(parcel.readStrongBinder()), parcel.readInt() != 0 ? (StreetViewPanoramaOptions) StreetViewPanoramaOptions.CREATOR.createFromParcel(parcel) : null, parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
                case 3:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                ...
                case 4:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                    zzd onCreateView = onCreateView(com.google.android.gms.dynamic.zzd.zza.zzbz(parcel.readStrongBinder()), com.google.android.gms.dynamic.zzd.zza.zzbz(parcel.readStrongBinder()), parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                ...
                case 12:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                    getStreetViewPanoramaAsync(com.google.android.gms.maps.internal.zzaa.zza.zzde(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
