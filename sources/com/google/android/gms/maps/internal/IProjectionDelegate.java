...
public interface IProjectionDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IProjectionDelegate {
        ...
        private static class zza implements IProjectionDelegate {
            ...
            public LatLng fromScreenLocation(zzd zzd) throws RemoteException {
                LatLng latLng = null;
        ...
        public static IProjectionDelegate zzdf(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                case 1:
                    ...
                    LatLng fromScreenLocation = fromScreenLocation(com.google.android.gms.dynamic.zzd.zza.zzbz(parcel.readStrongBinder()));
