...
@Instrumented
public final class zzpc extends Fragment implements zzor, TraceFieldInterface {
    ...
    public void onCreate(Bundle bundle) {
        TraceMachine.startTracing("zzpc");
        try {
            TraceMachine.enterMethod(this._nr_trace, "zzpc#onCreate", null);
        } catch (NoSuchFieldError e) {
            while (true) {
                TraceMachine.enterMethod(null, "zzpc#onCreate", null);
            }
        }
