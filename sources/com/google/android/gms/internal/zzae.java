...
public enum zzae {
    ...
    CUSTOMER_ID(BusinessArgs.KEY_CUSTOMER_ID),
    ...
    OPTOUT("optout"),
    ORDER(JiceArgs.EVENT_SUBMIT_ORDER),
    ORDER_ID("order_id"),
