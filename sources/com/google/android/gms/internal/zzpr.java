...
public interface zzpr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzpr {
        ...
        private static class zza implements zzpr {
        ...
        public static zzpr zzbc(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzpr)) ? new zza(iBinder) : (zzpr) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(com.google.android.gms.internal.zzpq.zza.zzbb(parcel.readStrongBinder()));
                    return true;
                case 1598968902:
