...
public class C0971ct {
    /* renamed from: a */
    public static Proxy m4002a(Context context) {
        try {
            if (VERSION.SDK_INT >= 11) {
                return C0971ct.m4003a(context, new URI("http://restapi.amap.com"));
            }
            return C0971ct.m4006b(context);
        } catch (Throwable th) {
            C0982da.m4076a(th, "ProxyUtil", "getProxy");
            return null;
        }
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:34:0x006c A:{Catch:{ Throwable -> 0x0154 }} */
    /* renamed from: b */
    private static java.net.Proxy m4006b(android.content.Context r12) {
        /*
        r10 = 0;
        r6 = 80;
        r9 = 1;
        r8 = -1;
        r7 = 0;
        r0 = com.amap.api.mapcore2d.C0971ct.m4007c(r12);
    ...
    L_0x0042:
        r3 = com.amap.api.mapcore2d.C0971ct.m4001a();	 Catch:{ SecurityException -> 0x017a, Throwable -> 0x0167 }
        r0 = com.amap.api.mapcore2d.C0971ct.m4005b();	 Catch:{ SecurityException -> 0x017a, Throwable -> 0x0167 }
    ...
    L_0x0066:
        r0 = com.amap.api.mapcore2d.C0971ct.m4004a(r3, r8);	 Catch:{ Throwable -> 0x0154 }
        if (r0 == 0) goto L_0x015f;
    L_0x006c:
    ...
    L_0x0083:
        r3 = com.amap.api.mapcore2d.C0971ct.m4001a();	 Catch:{ SecurityException -> 0x017a, Throwable -> 0x0167 }
        r1 = com.amap.api.mapcore2d.C0971ct.m4005b();	 Catch:{ SecurityException -> 0x017a, Throwable -> 0x0167 }
    ...
    L_0x00b2:
        r4 = "ProxyUtil";
        r5 = "getHostProxy";
        com.amap.api.mapcore2d.C0982da.m4076a(r0, r4, r5);	 Catch:{ all -> 0x0164 }
        r0 = com.amap.api.mapcore2d.C0968cq.m3972o(r12);	 Catch:{ all -> 0x0164 }
        if (r0 == 0) goto L_0x01a0;
    L_0x00bf:
        r2 = java.util.Locale.US;	 Catch:{ all -> 0x0164 }
        r4 = r0.toLowerCase(r2);	 Catch:{ all -> 0x0164 }
        r0 = com.amap.api.mapcore2d.C0971ct.m4001a();	 Catch:{ all -> 0x0164 }
        r2 = com.amap.api.mapcore2d.C0971ct.m4005b();	 Catch:{ all -> 0x0164 }
        r5 = "ctwap";
    ...
    L_0x0122:
        r1 = "ProxyUtil";
        r4 = "getHostProxy1";
        com.amap.api.mapcore2d.C0982da.m4076a(r0, r1, r4);	 Catch:{ all -> 0x0162 }
    ...
    L_0x01ad:
        ...
        goto L_0x0059;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.amap.api.mapcore2d.C0971ct.m4006b(android.content.Context):java.net.Proxy");
    }

    /* renamed from: a */
    private static boolean m4004a(String str, int i) {
        return (str == null || str.length() <= 0 || i == -1) ? false : true;
    }

    /* renamed from: a */
    private static String m4001a() {
        String defaultHost;
        try {
            defaultHost = android.net.Proxy.getDefaultHost();
        } catch (Throwable th) {
            C0982da.m4076a(th, "ProxyUtil", "getDefHost");
            defaultHost = null;
        }
        if (defaultHost == null) {
    ...
    /* renamed from: a */
    private static Proxy m4003a(Context context, URI uri) {
        if (C0971ct.m4007c(context)) {
            try {
                ...
                C0982da.m4076a(th, "ProxyUtil", "getProxySelectorCfg");
            }
        }
        return null;
    }
    ...
    /* renamed from: c */
    private static boolean m4007c(Context context) {
        return C0968cq.m3970m(context) == 0;
    }

    /* renamed from: b */
    private static int m4005b() {
        int i = -1;
        try {
            return android.net.Proxy.getDefaultPort();
        } catch (Throwable th) {
            C0982da.m4076a(th, "ProxyUtil", "getDefPort");
            return i;
        }
    }
}
