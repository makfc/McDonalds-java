...
public class Utils {
    /* renamed from: a */
    public static void m2512a(ByteArrayOutputStream byteArrayOutputStream, String str) {
        Utils.m2511a(byteArrayOutputStream, (byte) str.length(), Utils.m2515a(str));
    }

    /* renamed from: a */
    public static String m2509a(byte[] bArr) {
    ...
    /* renamed from: a */
    public static byte[] m2515a(String str) {
    ...
    /* renamed from: a */
    public static void m2511a(ByteArrayOutputStream byteArrayOutputStream, byte b, byte[] bArr) {
        int i = 1;
        try {
            ...
            BasicLogHandler.m2542a(e, "Utils", "writeField");
        }
    }

    /* renamed from: b */
    public static String m2516b(String str) {
        if (str == null) {
            return null;
        }
        String b = C0821dr.m2457b(Utils.m2515a(str));
        return ((char) ((b.length() % 26) + 65)) + b;
    }

    /* renamed from: c */
    public static String m2519c(String str) {
        if (str.length() < 2) {
            return "";
        }
        return C0821dr.m2453a(str.substring(1));
    }

    /* renamed from: a */
    public static boolean m2513a(JSONObject jSONObject, String str) {
        return jSONObject != null && jSONObject.has(str);
    }

    /* renamed from: a */
    public static byte[] m2514a() {
        int i = 0;
        try {
            ...
            split = new StringBuffer(new String(C0821dr.m2458b(new String(bArr)))).reverse().toString().split(",");
            ...
            BasicLogHandler.m2542a(th, "Utils", "getIV");
            return new byte[16];
        }
    }

    /* renamed from: a */
    static String m2508a(Map<String, String> map) {
        if (map == null) {
            return null;
        }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:35:0x004c A:{SYNTHETIC, Splitter:B:35:0x004c} */
    /* renamed from: a */
    public static java.lang.String m2507a(java.lang.Throwable r4) {
        /*
        r0 = 0;
    ...
    L_0x006f:
        ...
        goto L_0x002e;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.amap.api.mapcore.util.Utils.m2507a(java.lang.Throwable):java.lang.String");
    }

    /* renamed from: b */
    public static String m2517b(Map<String, String> map) {
        return Utils.m2521d(Utils.m2508a((Map) map));
    }

    /* renamed from: d */
    public static String m2521d(String str) {
        try {
            if (TextUtils.isEmpty(str)) {
                return "";
            }
            ...
            BasicLogHandler.m2542a(th, "Utils", "sortParams");
        }
    }

    /* renamed from: b */
    public static byte[] m2518b(byte[] bArr) {
        try {
            return Utils.m2525g(bArr);
        } catch (Throwable th) {
            BasicLogHandler.m2542a(th, "Utils", "gZip");
            return new byte[0];
        }
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:38:0x0065 A:{SYNTHETIC, Splitter:B:38:0x0065} */
    /* renamed from: c */
    public static byte[] m2520c(byte[] r6) {
        /*
        r0 = 0;
    ...
    L_0x0040:
        r4 = "Utils";
        r5 = "zip";
        com.amap.api.mapcore.util.BasicLogHandler.m2542a(r1, r4, r5);	 Catch:{ all -> 0x0095 }
    ...
    L_0x009a:
        ...
        goto L_0x0040;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.amap.api.mapcore.util.Utils.m2520c(byte[]):byte[]");
    }

    /* JADX WARNING: Removed duplicated region for block: B:29:0x0055 A:{SYNTHETIC, Splitter:B:29:0x0055} */
    /* renamed from: a */
    static java.security.PublicKey m2510a(android.content.Context r5) throws java.security.cert.CertificateException, java.security.spec.InvalidKeySpecException, java.security.NoSuchAlgorithmException, java.lang.NullPointerException, java.io.IOException {
        /*
        r0 = 0;
    ...
    L_0x0062:
        ...
        goto L_0x0045;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.amap.api.mapcore.util.Utils.m2510a(android.content.Context):java.security.PublicKey");
    }

    /* renamed from: d */
    static String m2522d(byte[] bArr) {
        try {
            return Utils.m2524f(bArr);
        } catch (Throwable th) {
            BasicLogHandler.m2542a(th, "Utils", "HexString");
            return null;
        }
    }

    /* renamed from: e */
    static String m2523e(byte[] bArr) {
        try {
            return Utils.m2524f(bArr);
        } catch (Throwable th) {
            th.printStackTrace();
    ...
    /* renamed from: f */
    public static String m2524f(byte[] bArr) {
        StringBuilder stringBuilder = new StringBuilder();
        if (bArr == null) {
            return null;
        }
    ...
    /* renamed from: g */
    private static byte[] m2525g(byte[] r4) throws java.io.IOException, java.lang.Throwable {
        /*
        r0 = 0;
    ...
    L_0x004d:
        ...
        goto L_0x002a;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.amap.api.mapcore.util.Utils.m2525g(byte[]):byte[]");
    }

    /* renamed from: a */
    public static String m2506a(long j) {
        String str = null;
        try {
