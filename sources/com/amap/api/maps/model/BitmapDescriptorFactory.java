...
import com.amap.api.mapcore.util.IResourceProxy.C0877a;
...
public final class BitmapDescriptorFactory {
    ...
    public static BitmapDescriptor fromResource(int i) {
        try {
            Context context = MapFragmentDelegateImp.f974a;
            if (context == null) {
                return null;
            }
    ...
    public static BitmapDescriptor fromView(View view) {
        try {
            ...
            Bitmap a = Util.m2347a(frameLayout);
    ...
    public static BitmapDescriptor defaultMarker() {
        try {
            return fromAsset(C0877a.marker_default.name() + ".png");
        } catch (Throwable th) {
            return null;
        }
    }
