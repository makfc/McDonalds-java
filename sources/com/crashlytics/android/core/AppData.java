...
class AppData {
    ...
    public static AppData create(Context context, IdManager idManager, String apiKey, String buildId) throws NameNotFoundException {
        ...
        return new AppData(apiKey, buildId, installerPackageName, packageName, Integer.toString(packageInfo.versionCode), packageInfo.versionName == null ? "0.0" : packageInfo.versionName);
    }
