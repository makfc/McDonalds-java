...
final class SessionEvent {
    ...
    public static Builder installEventBuilder(long installedAt) {
        return new Builder(Type.INSTALL).details(Collections.singletonMap("installedAt", String.valueOf(installedAt)));
    }
    ...
    public static Builder crashEventBuilder(String sessionId, String exceptionName) {
        return crashEventBuilder(sessionId).customAttributes(Collections.singletonMap("exceptionName", exceptionName));
    }
