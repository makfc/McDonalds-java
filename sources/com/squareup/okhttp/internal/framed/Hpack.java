...
final class Hpack {
    ...
    static final class Reader {
        ...
        public void headerTableSizeSetting(int headerTableSizeSetting) {
            this.headerTableSizeSetting = headerTableSizeSetting;
            this.maxDynamicTableByteCount = headerTableSizeSetting;
        ...
        public void readHeaders() throws IOException {
            while (!this.source.exhausted()) {
                ...
                if (b == 128) {
                    ...
                    readIndexedHeader(readInt(b, TransportMediator.KEYCODE_MEDIA_PAUSE) - 1);
                } else if (b == 64) {
        ...
        public int readInt(int firstByte, int prefixMask) throws IOException {
            ...
            while (true) {
                ...
                result += (b & TransportMediator.KEYCODE_MEDIA_PAUSE) << shift;
                shift += 7;
            }
        }
        ...
        public ByteString readByteString() throws IOException {
            ...
            int length = readInt(firstByte, TransportMediator.KEYCODE_MEDIA_PAUSE);
            if (huffmanDecode) {
                return ByteString.m8637of(Huffman.get().decode(this.source.readByteArray((long) length)));
            }
    ...
    static final class Writer {
        ...
        public void writeInt(int value, int prefixMask, int bits) throws IOException {
            ...
            value -= prefixMask;
            while (value >= 128) {
                this.out.writeByte((value & TransportMediator.KEYCODE_MEDIA_PAUSE) | 128);
                value >>>= 7;
            }
        ...
        public void writeByteString(ByteString data) throws IOException {
            writeInt(data.size(), TransportMediator.KEYCODE_MEDIA_PAUSE, 0);
            this.out.write(data);
        }
    }
