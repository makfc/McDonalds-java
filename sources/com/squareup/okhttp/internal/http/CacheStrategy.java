    ...
    public static class Factory {
        ...
        private CacheStrategy getCandidate() {
            ...
            if (responseCaching.noCache() || ageMillis + minFreshMillis >= freshMillis + maxStaleMillis) {
                ...
                Request conditionalRequest = !(conditionalRequestBuilder instanceof Builder) ? conditionalRequestBuilder.build() : OkHttp2Instrumentation.build(conditionalRequestBuilder);
            ...
            if (response instanceof Response.Builder) {
                builder = OkHttp2Instrumentation.newBuilder((Response.Builder) response);
            } else {
