...
public final class OkHeaders {
    private static final Comparator<String> FIELD_NAME_COMPARATOR = new C43091();
    ...
    static class C43091 implements Comparator<String> {
        C43091() {
        }
    ...
    public static long contentLength(Headers headers) {
        return stringToLong(headers.get(TransactionStateUtil.CONTENT_LENGTH_HEADER));
    }
