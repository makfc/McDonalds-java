...
public class JsonReader implements Closeable {
    ...
    /* renamed from: com.newrelic.com.google.gson.stream.JsonReader$1 */
    static class C42221 extends JsonReaderInternalAccess {
        C42221() {
        }
    ...
    static {
        JsonReaderInternalAccess.INSTANCE = new C42221();
    }
    ...
    private int peekKeyword() throws IOException {
        ...
        if (c == 't' || c == 'T') {
            ...
            keyword = SafeJsonPrimitive.NULL_STRING;
            keywordUpper = "NULL";
            peeking = 7;
        }
    ...
    private boolean fillBuffer(int minimum) throws IOException {
        ...
        this.pos = 0;
        do {
            int total = this.f6701in.read(buffer, this.limit, buffer.length - this.limit);
            if (total == -1) {
                return false;
            }
            this.limit += total;
