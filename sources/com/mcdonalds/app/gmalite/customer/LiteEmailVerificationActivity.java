...
public class LiteEmailVerificationActivity extends URLActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        transaction.replace(getContainerResource(), passIntentExtrasAsArgument(new LiteEmailVerificationFragment()));
        transaction.commit();
    }
}
