...
public class LitePolicyUpdatesActivity extends URLActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(getContainerResource(), passIntentExtrasAsArgument(new LitePolicyUpdatesFragment())).commit();
    }
}
