...
public class LiteSmsVerificationActivity extends URLActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        transaction.replace(getContainerResource(), passIntentExtrasAsArgument(new LiteSmsVerificationFragment()));
        transaction.commit();
    }
}
