...
public class LiteSignUpActivity extends URLActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        transaction.replace(getContainerResource(), passIntentExtrasAsArgument(new LiteSignUpFragment()));
        transaction.commit();
    }
}
