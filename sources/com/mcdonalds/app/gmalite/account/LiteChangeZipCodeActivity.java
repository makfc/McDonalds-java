...
public class LiteChangeZipCodeActivity extends URLActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        transaction.replace(getContainerResource(), passIntentExtrasAsArgument(new LiteChangeZipCodeFragment()));
        transaction.commit();
    }
}
