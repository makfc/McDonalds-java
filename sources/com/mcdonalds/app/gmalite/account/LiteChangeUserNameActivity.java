...
public class LiteChangeUserNameActivity extends URLActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        transaction.replace(getContainerResource(), passIntentExtrasAsArgument(new LiteChangeUserNameFragment()));
        transaction.commit();
    }
}
