...
public class MWJSONRequestBody extends LinkedHashMap<String, Object> {
    private final String mConfigBasePath;
    private GsonBuilder mGsonBuilder;

    @Deprecated
    public MWJSONRequestBody(MiddlewareConnector ignored) {
        this();
    }

    @Deprecated
    public MWJSONRequestBody(MiddlewareConnector ignored, boolean serializeNulls) {
        this(serializeNulls);
    }

    public MWJSONRequestBody() {
        this.mGsonBuilder = new GsonBuilder().serializeNulls();
        this.mConfigBasePath = MiddlewareConnector.CONFIG_BASE_PATH;
        putDefaults();
    }

    public MWJSONRequestBody(MWCustomerSecurityConnector connector) {
        this.mGsonBuilder = new GsonBuilder().serializeNulls();
        this.mConfigBasePath = connector.getConfigBasePath();
        putDefaults();
    }

    public MWJSONRequestBody(boolean serializeNulls) {
        this.mConfigBasePath = MiddlewareConnector.CONFIG_BASE_PATH;
