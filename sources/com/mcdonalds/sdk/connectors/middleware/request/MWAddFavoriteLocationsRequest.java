...
public class MWAddFavoriteLocationsRequest extends MWRequest<MWFavoriteLocationsResponse, MWJSONRequestBody> {
    private static final String URL_PATH = "/customer/favorite/location";
    private final MWRequestHeaders mHeaderMap;
    private final MWJSONRequestBody mPostBody;

    @Deprecated
    public MWAddFavoriteLocationsRequest(MiddlewareConnector ignored, String ecpToken, String username, List<Map<String, Object>> locations) {
        this(ecpToken, username, locations);
    }

    public MWAddFavoriteLocationsRequest(String ecpToken, String username, List<Map<String, Object>> locations) {
