...
public class C1376j extends C1363c {
    /* renamed from: d */
    protected String f4827d;

    public C1376j(C1378l c1378l, Context context, String str) {
    ...
    public void mo13722a(HashMap<String, String> hashMap) {
        ...
        hashMap.put("tags", this.f4827d);
        C1425a.m6442c("DelTags", "DelTags param -- " + C1370b.m6202a((HashMap) hashMap));
    }
}
