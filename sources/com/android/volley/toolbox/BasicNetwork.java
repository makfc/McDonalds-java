...
public class BasicNetwork implements Network {
    ...
    L_0x00fd:
        ...
        r7 = r27.getUrl();
        r4[r5] = r7;
        com.android.volley.VolleyLog.m5263e(r3, r4);
    ...
    private void logSlowRequests(long requestLifetime, Request<?> request, byte[] responseContents, StatusLine statusLine) {
        if (DEBUG || requestLifetime > ((long) SLOW_REQUEST_THRESHOLD_MS)) {
            ...
            objArr[2] = responseContents != null ? Integer.valueOf(responseContents.length) : SafeJsonPrimitive.NULL_STRING;
            objArr[3] = Integer.valueOf(statusLine.getStatusCode());
            objArr[4] = Integer.valueOf(request.getRetryPolicy().getCurrentRetryCount());
            VolleyLog.m5262d(str, objArr);
        }
    }
    ...
    private byte[] entityToBytes(HttpEntity entity) throws IOException, ServerError {
        ...
        try {
            ...
            try {
                ...
                VolleyLog.m5265v("Error occured when calling consumingContent", new Object[0]);
            }
