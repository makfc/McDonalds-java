...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    class C01261 implements Callback {
        C01261() {
        }
    ...
    class C01272 extends AnimatorListenerAdapter {
        final /* synthetic */ AnimatedVectorDrawableCompat this$0;

        public void onAnimationStart(Animator animation) {
            ArrayList<AnimationCallback> tmpCallbacks = new ArrayList(this.this$0.mAnimationCallbacks);
            int size = tmpCallbacks.size();
            for (int i = 0; i < size; i++) {
                ((AnimationCallback) tmpCallbacks.get(i)).onAnimationStart(this.this$0);
            }
        }
        ...
        public void onAnimationEnd(Animator animation) {
            ...
            int size = tmpCallbacks.size();
            for (int i = 0; i < size; i++) {
                ((AnimationCallback) tmpCallbacks.get(i)).onAnimationEnd(this.this$0);
            }
        }
    }
