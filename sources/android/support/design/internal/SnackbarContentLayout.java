...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attrs) {
        ...
        this.mMaxWidth = a.getDimensionPixelSize(C0045R.styleable.SnackbarLayout_android_maxWidth, -1);
        this.mMaxInlineActionWidth = a.getDimensionPixelSize(C0045R.styleable.SnackbarLayout_maxActionInlineWidth, -1);
        a.recycle();
    }
    ...
    public void onFinishInflate() {
        ...
        this.mMessageView = (TextView) findViewById(C0045R.C0044id.snackbar_text);
        this.mActionView = (Button) findViewById(C0045R.C0044id.snackbar_action);
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int multiLineVPadding = getResources().getDimensionPixelSize(C0045R.dimen.design_snackbar_padding_vertical_2lines);
        int singleLineVPadding = getResources().getDimensionPixelSize(C0045R.dimen.design_snackbar_padding_vertical);
