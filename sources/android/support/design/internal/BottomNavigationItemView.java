...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int inactiveLabelSize = res.getDimensionPixelSize(C0045R.dimen.design_bottom_navigation_text_size);
        int activeLabelSize = res.getDimensionPixelSize(C0045R.dimen.design_bottom_navigation_active_text_size);
        this.mDefaultMargin = res.getDimensionPixelSize(C0045R.dimen.design_bottom_navigation_margin);
        ...
        LayoutInflater.from(context).inflate(C0045R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C0045R.C0043drawable.design_bottom_navigation_item_background);
        this.mIcon = (ImageView) findViewById(C0045R.C0044id.icon);
        this.mSmallLabel = (TextView) findViewById(C0045R.C0044id.smallLabel);
        this.mLargeLabel = (TextView) findViewById(C0045R.C0044id.largeLabel);
    }
