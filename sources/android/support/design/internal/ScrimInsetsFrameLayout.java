...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    class C00621 implements OnApplyWindowInsetsListener {
        C00621() {
        }
    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0045R.styleable.ScrimInsetsFrameLayout, defStyleAttr, C0045R.style.Widget_Design_ScrimInsetsFrameLayout);
        this.mInsetForeground = a.getDrawable(C0045R.styleable.ScrimInsetsFrameLayout_insetForeground);
        a.recycle();
        setWillNotDraw(true);
        ViewCompat.setOnApplyWindowInsetsListener(this, new C00621());
    }
