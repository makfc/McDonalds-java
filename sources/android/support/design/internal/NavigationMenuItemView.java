...
import android.support.p001v7.view.menu.MenuView.ItemView;
import android.support.p001v7.widget.LinearLayoutCompat.LayoutParams;
...
public class NavigationMenuItemView extends ForegroundLinearLayout implements ItemView {
    ...
    class C00501 extends AccessibilityDelegateCompat {
        C00501() {
        }
    ...
    public NavigationMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mAccessibilityDelegate = new C00501();
        setOrientation(0);
        LayoutInflater.from(context).inflate(C0045R.layout.design_navigation_menu_item, this, true);
        this.mIconSize = context.getResources().getDimensionPixelSize(C0045R.dimen.design_navigation_icon_size);
        this.mTextView = (CheckedTextView) findViewById(C0045R.C0044id.design_menu_item_text);
    ...
    private void setActionView(View actionView) {
        if (actionView != null) {
            if (this.mActionArea == null) {
                this.mActionArea = (FrameLayout) ((ViewStub) findViewById(C0045R.C0044id.design_menu_item_action_area_stub)).inflate();
            }
            this.mActionArea.removeAllViews();
    ...
    public void setIcon(Drawable icon) {
        if (icon != null) {
            ...
            if (this.mEmptyDrawable == null) {
                this.mEmptyDrawable = ResourcesCompat.getDrawable(getResources(), C0045R.C0043drawable.navigation_empty_icon, getContext().getTheme());
                if (this.mEmptyDrawable != null) {
