...
public class BottomSheetBehavior<V extends View> extends Behavior<V> {
    ...
    private final Callback mDragCallback = new C00852();
    boolean mHideable;
    ...
    protected static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C00861());
        final int state;

        /* renamed from: android.support.design.widget.BottomSheetBehavior$SavedState$1 */
        static class C00861 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C00861() {
            }
    ...
    public BottomSheetBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, C0045R.styleable.BottomSheetBehavior_Layout);
        TypedValue value = a.peekValue(C0045R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight);
        if (value == null || value.data != -1) {
            setPeekHeight(a.getDimensionPixelSize(C0045R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight, -1));
        } else {
            setPeekHeight(value.data);
        }
        setHideable(a.getBoolean(C0045R.styleable.BottomSheetBehavior_Layout_behavior_hideable, false));
        setSkipCollapsed(a.getBoolean(C0045R.styleable.BottomSheetBehavior_Layout_behavior_skipCollapsed, false));
        a.recycle();
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, V child, int layoutDirection) {
        ...
        if (this.mPeekHeightAuto) {
            if (this.mPeekHeightMin == 0) {
                this.mPeekHeightMin = parent.getResources().getDimensionPixelSize(C0045R.dimen.design_bottom_sheet_peek_height_min);
            }
