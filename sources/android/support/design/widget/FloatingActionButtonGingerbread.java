...
class FloatingActionButtonGingerbread extends FloatingActionButtonImpl {
    ...
    private abstract class ShadowAnimatorImpl extends AnimatorListenerAdapter implements AnimatorUpdateListener {
        ...
        /* synthetic */ ShadowAnimatorImpl(FloatingActionButtonGingerbread x0, C00991 x1) {
            this();
        }
    ...
    public void hide(@Nullable final InternalVisibilityChangedListener listener, final boolean fromUser) {
        if (!isOrWillBeHidden()) {
            this.mAnimState = 1;
            Animation anim = AnimationUtils.loadAnimation(this.mView.getContext(), C0045R.anim.design_fab_out);
    ...
    public void show(@Nullable final InternalVisibilityChangedListener listener, boolean fromUser) {
        if (!isOrWillBeShown()) {
            ...
            Animation anim = AnimationUtils.loadAnimation(this.mView.getContext(), C0045R.anim.design_fab_in);
            anim.setDuration(200);
