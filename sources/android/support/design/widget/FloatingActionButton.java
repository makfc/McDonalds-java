...
import android.support.p001v7.widget.AppCompatImageHelper;
...
public class FloatingActionButton extends VisibilityAwareImageButton {
    ...
    public static class Behavior extends android.support.design.widget.CoordinatorLayout.Behavior<FloatingActionButton> {
        ...
        public Behavior(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0045R.styleable.FloatingActionButton_Behavior_Layout);
            this.mAutoHideEnabled = a.getBoolean(C0045R.styleable.FloatingActionButton_Behavior_Layout_behavior_autoHide, true);
            a.recycle();
        }
    ...
    public FloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0045R.styleable.FloatingActionButton, defStyleAttr, C0045R.style.Widget_Design_FloatingActionButton);
        this.mBackgroundTint = a.getColorStateList(C0045R.styleable.FloatingActionButton_backgroundTint);
        this.mBackgroundTintMode = ViewUtils.parseTintMode(a.getInt(C0045R.styleable.FloatingActionButton_backgroundTintMode, -1), null);
        this.mRippleColor = a.getColor(C0045R.styleable.FloatingActionButton_rippleColor, 0);
        this.mSize = a.getInt(C0045R.styleable.FloatingActionButton_fabSize, -1);
        this.mBorderWidth = a.getDimensionPixelSize(C0045R.styleable.FloatingActionButton_borderWidth, 0);
        float elevation = a.getDimension(C0045R.styleable.FloatingActionButton_elevation, 0.0f);
        float pressedTranslationZ = a.getDimension(C0045R.styleable.FloatingActionButton_pressedTranslationZ, 0.0f);
        this.mCompatPadding = a.getBoolean(C0045R.styleable.FloatingActionButton_useCompatPadding, false);
        a.recycle();
        this.mImageHelper = new AppCompatImageHelper(this);
        this.mImageHelper.loadFromAttributes(attrs, defStyleAttr);
        this.mMaxImageSize = (int) getResources().getDimension(C0045R.dimen.design_fab_image_size);
    ...
    private int getSizeDimension(int size) {
        ...
        switch (size) {
            ...
            case 1:
                return res.getDimensionPixelSize(C0045R.dimen.design_fab_size_mini);
            default:
                return res.getDimensionPixelSize(C0045R.dimen.design_fab_size_normal);
        }
    }
