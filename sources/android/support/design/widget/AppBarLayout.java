...
public class AppBarLayout extends LinearLayout {
    ...
    class C00651 implements OnApplyWindowInsetsListener {
        C00651() {
        }
    ...
    public static class LayoutParams extends android.widget.LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            TypedArray a = c.obtainStyledAttributes(attrs, C0045R.styleable.AppBarLayout_Layout);
            this.mScrollFlags = a.getInt(C0045R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            if (a.hasValue(C0045R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                this.mScrollInterpolator = AnimationUtils.loadInterpolator(c, a.getResourceId(C0045R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
            a.recycle();
        }
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0045R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(a.getDimensionPixelSize(C0045R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            a.recycle();
        }
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            ViewUtilsLollipop.setStateListAnimatorFromAttrs(this, attrs, 0, C0045R.style.Widget_Design_AppBarLayout);
        }
        TypedArray a = context.obtainStyledAttributes(attrs, C0045R.styleable.AppBarLayout, 0, C0045R.style.Widget_Design_AppBarLayout);
        ViewCompat.setBackground(this, a.getDrawable(C0045R.styleable.AppBarLayout_android_background));
        if (a.hasValue(C0045R.styleable.AppBarLayout_expanded)) {
            setExpanded(a.getBoolean(C0045R.styleable.AppBarLayout_expanded, false), false, false);
        }
        if (VERSION.SDK_INT >= 21 && a.hasValue(C0045R.styleable.AppBarLayout_elevation)) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, (float) a.getDimensionPixelSize(C0045R.styleable.AppBarLayout_elevation, 0));
        }
        a.recycle();
        ViewCompat.setOnApplyWindowInsetsListener(this, new C00651());
    }
    ...
    public int[] onCreateDrawableState(int extraSpace) {
        ...
        extraStates[0] = this.mCollapsible ? C0045R.attr.state_collapsible : -C0045R.attr.state_collapsible;
        int i = (this.mCollapsible && this.mCollapsed) ? C0045R.attr.state_collapsed : -C0045R.attr.state_collapsed;
        extraStates[1] = i;
