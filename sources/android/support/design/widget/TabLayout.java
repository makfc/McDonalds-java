...
public class TabLayout extends HorizontalScrollView {
    ...
    class C01091 implements AnimatorUpdateListener {
        C01091() {
        }
    ...
    class TabView extends LinearLayout implements OnLongClickListener {
        ...
        public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
            ...
            event.setClassName(android.support.p001v7.app.ActionBar.Tab.class.getName());
        }

        @TargetApi(14)
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
            super.onInitializeAccessibilityNodeInfo(info);
            info.setClassName(android.support.p001v7.app.ActionBar.Tab.class.getName());
        }
        ...
        public void onMeasure(int origWidthMeasureSpec, int origHeightMeasureSpec) {
            ...
            if (maxWidth <= 0 || (specWidthMode != 0 && specWidthSize <= maxWidth)) {
                ...
                widthMeasureSpec = MeasureSpec.makeMeasureSpec(TabLayout.this.mTabMaxWidth, ExploreByTouchHelper.INVALID_ID);
            }
            super.onMeasure(widthMeasureSpec, heightMeasureSpec);
            if (this.mTextView != null) {
        ...
        public final void update() {
            ...
            if (this.mCustomView == null) {
                if (this.mIconView == null) {
                    ImageView iconView = (ImageView) LayoutInflater.from(getContext()).inflate(C0045R.layout.design_layout_tab_icon, this, false);
                    addView(iconView, 0);
                    this.mIconView = iconView;
                }
                if (this.mTextView == null) {
                    TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(C0045R.layout.design_layout_tab_text, this, false);
                    addView(textView);
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0045R.styleable.TabLayout, defStyleAttr, C0045R.style.Widget_Design_TabLayout);
        this.mTabStrip.setSelectedIndicatorHeight(a.getDimensionPixelSize(C0045R.styleable.TabLayout_tabIndicatorHeight, 0));
        this.mTabStrip.setSelectedIndicatorColor(a.getColor(C0045R.styleable.TabLayout_tabIndicatorColor, 0));
        int dimensionPixelSize = a.getDimensionPixelSize(C0045R.styleable.TabLayout_tabPadding, 0);
        this.mTabPaddingBottom = dimensionPixelSize;
        this.mTabPaddingEnd = dimensionPixelSize;
        this.mTabPaddingTop = dimensionPixelSize;
        this.mTabPaddingStart = dimensionPixelSize;
        this.mTabPaddingStart = a.getDimensionPixelSize(C0045R.styleable.TabLayout_tabPaddingStart, this.mTabPaddingStart);
        this.mTabPaddingTop = a.getDimensionPixelSize(C0045R.styleable.TabLayout_tabPaddingTop, this.mTabPaddingTop);
        this.mTabPaddingEnd = a.getDimensionPixelSize(C0045R.styleable.TabLayout_tabPaddingEnd, this.mTabPaddingEnd);
        this.mTabPaddingBottom = a.getDimensionPixelSize(C0045R.styleable.TabLayout_tabPaddingBottom, this.mTabPaddingBottom);
        this.mTabTextAppearance = a.getResourceId(C0045R.styleable.TabLayout_tabTextAppearance, C0045R.style.TextAppearance_Design_Tab);
        ...
        try {
            ...
            if (a.hasValue(C0045R.styleable.TabLayout_tabTextColor)) {
                this.mTabTextColors = a.getColorStateList(C0045R.styleable.TabLayout_tabTextColor);
            }
            if (a.hasValue(C0045R.styleable.TabLayout_tabSelectedTextColor)) {
                this.mTabTextColors = createColorStateList(this.mTabTextColors.getDefaultColor(), a.getColor(C0045R.styleable.TabLayout_tabSelectedTextColor, 0));
            }
            this.mRequestedTabMinWidth = a.getDimensionPixelSize(C0045R.styleable.TabLayout_tabMinWidth, -1);
            this.mRequestedTabMaxWidth = a.getDimensionPixelSize(C0045R.styleable.TabLayout_tabMaxWidth, -1);
            this.mTabBackgroundResId = a.getResourceId(C0045R.styleable.TabLayout_tabBackground, 0);
            this.mContentInsetStart = a.getDimensionPixelSize(C0045R.styleable.TabLayout_tabContentStart, 0);
            this.mMode = a.getInt(C0045R.styleable.TabLayout_tabMode, 1);
            this.mTabGravity = a.getInt(C0045R.styleable.TabLayout_tabGravity, 0);
            a.recycle();
            Resources res = getResources();
            this.mTabTextMultiLineSize = (float) res.getDimensionPixelSize(C0045R.dimen.design_tab_text_size_2line);
            this.mScrollableTabMinWidth = res.getDimensionPixelSize(C0045R.dimen.design_tab_scrollable_min_width);
            applyModeAndGravity();
        } finally {
            ta.recycle();
        }
    ...
    private void ensureScrollAnimator() {
        if (this.mScrollAnimator == null) {
            ...
            this.mScrollAnimator.addUpdateListener(new C01091());
        }
    }
