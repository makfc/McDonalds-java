...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    class C00961 implements OnApplyWindowInsetsListener {
        C00961() {
        }
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0045R.styleable.CoordinatorLayout_Layout);
            this.gravity = a.getInteger(C0045R.styleable.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.mAnchorId = a.getResourceId(C0045R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = a.getInteger(C0045R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.keyline = a.getInteger(C0045R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = a.getInt(C0045R.styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.dodgeInsetEdges = a.getInt(C0045R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            this.mBehaviorResolved = a.hasValue(C0045R.styleable.CoordinatorLayout_Layout_layout_behavior);
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attrs, a.getString(C0045R.styleable.CoordinatorLayout_Layout_layout_behavior));
            }
            a.recycle();
    ...
    protected static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C00971());
        SparseArray<Parcelable> behaviorStates;

        /* renamed from: android.support.design.widget.CoordinatorLayout$SavedState$1 */
        static class C00971 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C00971() {
            }
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0045R.styleable.CoordinatorLayout, defStyleAttr, C0045R.style.Widget_Design_CoordinatorLayout);
        int keylineArrayRes = a.getResourceId(C0045R.styleable.CoordinatorLayout_keylines, 0);
        ...
        this.mStatusBarBackground = a.getDrawable(C0045R.styleable.CoordinatorLayout_statusBarBackground);
        a.recycle();
        setupForInsets();
    ...
    public boolean onTouchEvent(android.view.MotionEvent r15) {
        ...
        r11 = 0;
        r10 = 0;
        r8 = android.support.p000v4.view.MotionEventCompat.getActionMasked(r15);
        ...
        if (VERSION.SDK_INT >= 21) {
            if (ViewCompat.getFitsSystemWindows(this)) {
                if (this.mApplyWindowInsetsListener == null) {
                    this.mApplyWindowInsetsListener = new C00961();
                }
