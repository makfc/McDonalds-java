...
public final class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    public static Snackbar make(@NonNull View view, @NonNull CharSequence text, int duration) {
        ...
        SnackbarContentLayout content = (SnackbarContentLayout) LayoutInflater.from(parent.getContext()).inflate(C0045R.layout.design_layout_snackbar_include, parent, false);
