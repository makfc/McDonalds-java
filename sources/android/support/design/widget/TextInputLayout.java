...
import android.support.p001v7.widget.DrawableUtils;
...
public class TextInputLayout extends LinearLayout {
    ...
    class C01121 implements TextWatcher {
        C01121() {
        }
    ...
    class C01132 extends ViewPropertyAnimatorListenerAdapter {
        C01132() {
        }
    ...
    class C01154 implements OnClickListener {
        C01154() {
        }
    ...
    class C01165 implements AnimatorUpdateListener {
        C01165() {
        }
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C01171());
        CharSequence error;

        /* renamed from: android.support.design.widget.TextInputLayout$SavedState$1 */
        static class C01171 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C01171() {
            }
    ...
    public TextInputLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0045R.styleable.TextInputLayout, defStyleAttr, C0045R.style.Widget_Design_TextInputLayout);
        this.mHintEnabled = a.getBoolean(C0045R.styleable.TextInputLayout_hintEnabled, true);
        setHint(a.getText(C0045R.styleable.TextInputLayout_android_hint));
        this.mHintAnimationEnabled = a.getBoolean(C0045R.styleable.TextInputLayout_hintAnimationEnabled, true);
        if (a.hasValue(C0045R.styleable.TextInputLayout_android_textColorHint)) {
            ColorStateList colorStateList = a.getColorStateList(C0045R.styleable.TextInputLayout_android_textColorHint);
            this.mFocusedTextColor = colorStateList;
            this.mDefaultTextColor = colorStateList;
        }
        if (a.getResourceId(C0045R.styleable.TextInputLayout_hintTextAppearance, -1) != -1) {
            setHintTextAppearance(a.getResourceId(C0045R.styleable.TextInputLayout_hintTextAppearance, 0));
        }
        this.mErrorTextAppearance = a.getResourceId(C0045R.styleable.TextInputLayout_errorTextAppearance, 0);
        boolean errorEnabled = a.getBoolean(C0045R.styleable.TextInputLayout_errorEnabled, false);
        boolean counterEnabled = a.getBoolean(C0045R.styleable.TextInputLayout_counterEnabled, false);
        setCounterMaxLength(a.getInt(C0045R.styleable.TextInputLayout_counterMaxLength, -1));
        this.mCounterTextAppearance = a.getResourceId(C0045R.styleable.TextInputLayout_counterTextAppearance, 0);
        this.mCounterOverflowTextAppearance = a.getResourceId(C0045R.styleable.TextInputLayout_counterOverflowTextAppearance, 0);
        this.mPasswordToggleEnabled = a.getBoolean(C0045R.styleable.TextInputLayout_passwordToggleEnabled, false);
        this.mPasswordToggleDrawable = a.getDrawable(C0045R.styleable.TextInputLayout_passwordToggleDrawable);
        this.mPasswordToggleContentDesc = a.getText(C0045R.styleable.TextInputLayout_passwordToggleContentDescription);
        if (a.hasValue(C0045R.styleable.TextInputLayout_passwordToggleTint)) {
            this.mHasPasswordToggleTintList = true;
            this.mPasswordToggleTintList = a.getColorStateList(C0045R.styleable.TextInputLayout_passwordToggleTint);
        }
        if (a.hasValue(C0045R.styleable.TextInputLayout_passwordToggleTintMode)) {
            this.mHasPasswordToggleTintMode = true;
            this.mPasswordToggleTintMode = ViewUtils.parseTintMode(a.getInt(C0045R.styleable.TextInputLayout_passwordToggleTintMode, -1), null);
        }
        a.recycle();
    ...
    private void setEditText(EditText editText) {
        ...
        this.mEditText.addTextChangedListener(new C01121());
    ...
    public void setErrorEnabled(boolean enabled) {
        if (this.mErrorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                this.mErrorView.setId(C0045R.C0044id.textinput_error);
                ...
                if (useDefaultColor) {
                    ...
                    this.mErrorView.setTextColor(ContextCompat.getColor(getContext(), C0045R.color.design_textinput_error_color_light));
                }
    ...
    private void setError(@Nullable final CharSequence error, boolean animate) {
        ...
        if (this.mErrorShown) {
            ...
            if (animate) {
                ...
                ViewCompat.animate(this.mErrorView).alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new C01132()).start();
            } else {
    ...
    public void setCounterEnabled(boolean enabled) {
        if (this.mCounterEnabled != enabled) {
            if (enabled) {
                ...
                this.mCounterView.setId(C0045R.C0044id.textinput_counter);
                if (this.mTypeface != null) {
                ...
                try {
                    ...
                    this.mCounterView.setTextColor(ContextCompat.getColor(getContext(), C0045R.color.design_textinput_error_color_light));
                }
    ...
    public void updateCounter(int length) {
        ...
        if (this.mCounterMaxLength == -1) {
            ...
            this.mCounterView.setText(getContext().getString(C0045R.string.character_counter_pattern, new Object[]{Integer.valueOf(length), Integer.valueOf(this.mCounterMaxLength)}));
        }
        ...
        if (this.mEditText != null) {
            ...
            if (shouldShowPasswordIcon()) {
                if (this.mPasswordToggleView == null) {
                    this.mPasswordToggleView = (CheckableImageButton) LayoutInflater.from(getContext()).inflate(C0045R.layout.design_text_input_password_icon, this.mInputFrame, false);
                    ...
                    this.mPasswordToggleView.setOnClickListener(new C01154());
                }
    ...
    public void animateToExpansionFraction(float target) {
        if (this.mCollapsingTextHelper.getExpansionFraction() != target) {
            if (this.mAnimator == null) {
                ...
                this.mAnimator.addUpdateListener(new C01165());
            }
