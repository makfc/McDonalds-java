...
import android.support.p001v7.widget.MenuItemHoverListener;
import android.support.p001v7.widget.MenuPopupWindow;
...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    ...
    private final MenuItemHoverListener mMenuItemHoverListener = new C03522();
    ...
    class C03522 implements MenuItemHoverListener {
        C03522() {
        }
