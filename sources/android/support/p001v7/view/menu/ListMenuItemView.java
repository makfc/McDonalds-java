...
public class ListMenuItemView extends LinearLayout implements ItemView {
    ...
    public void onFinishInflate() {
        ...
        this.mTitleView = (TextView) findViewById(C0334R.C0333id.title);
        if (this.mTextAppearance != -1) {
            this.mTitleView.setTextAppearance(this.mTextAppearanceContext, this.mTextAppearance);
        }
        this.mShortcutView = (TextView) findViewById(C0334R.C0333id.shortcut);
        this.mSubMenuArrowView = (ImageView) findViewById(C0334R.C0333id.submenuarrow);
