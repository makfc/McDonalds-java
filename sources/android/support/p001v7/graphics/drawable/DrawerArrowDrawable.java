package android.support.p001v7.graphics.drawable;
...
public class DrawerArrowDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        float arrowHeadBarLength = DrawerArrowDrawable.lerp(this.mBarLength, (float) Math.sqrt((double) ((this.mArrowHeadLength * this.mArrowHeadLength) * 2.0f)), this.mProgress);
        float arrowShaftLength = DrawerArrowDrawable.lerp(this.mBarLength, this.mArrowShaftLength, this.mProgress);
        float arrowShaftCut = (float) Math.round(DrawerArrowDrawable.lerp(0.0f, this.mMaxCutForBarSize, this.mProgress));
        ...
        float canvasRotate = DrawerArrowDrawable.lerp(f, f2, this.mProgress);
        ...
        this.mPath.rewind();
        float topBottomBarOffset = DrawerArrowDrawable.lerp(this.mBarGap + this.mPaint.getStrokeWidth(), -this.mMaxCutForBarSize, this.mProgress);
    ...
    public void setProgress(@FloatRange float progress) {
