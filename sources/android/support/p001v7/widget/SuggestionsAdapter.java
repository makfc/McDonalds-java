...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            ...
            this.mIconRefine = (ImageView) v.findViewById(C0334R.C0333id.edit_query);
        }
    }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        ((ImageView) v.findViewById(C0334R.C0333id.edit_query)).setImageResource(this.mCommitIconResId);
        return v;
    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (views.mText1 != null) {
            setViewText(views.mText1, SuggestionsAdapter.getStringOrNull(cursor, this.mText1Col));
        }
        if (views.mText2 != null) {
            ...
            if (text2 != null) {
                ...
                text2 = SuggestionsAdapter.getStringOrNull(cursor, this.mText2Col);
            }
    ...
    public CharSequence convertToString(Cursor cursor) {
        ...
        CharSequence query = SuggestionsAdapter.getColumnString(cursor, "suggest_intent_query");
        if (query != null) {
            return query;
        }
        if (this.mSearchable.shouldRewriteQueryFromData()) {
            String data = SuggestionsAdapter.getColumnString(cursor, "suggest_intent_data");
            if (data != null) {
                return data;
            }
        }
        if (this.mSearchable.shouldRewriteQueryFromText()) {
            String text1 = SuggestionsAdapter.getColumnString(cursor, "suggest_text_1");
            if (text1 != null) {
                return text1;
            }
        }
    ...
    public static String getColumnString(Cursor cursor, String columnName) {
        return SuggestionsAdapter.getStringOrNull(cursor, cursor.getColumnIndex(columnName));
    }
    ...
    public Cursor getSearchManagerSuggestions(SearchableInfo searchable, String query, int limit) {
        ...
        if (limit > 0) {
            uriBuilder.appendQueryParameter(Parameters.LIMIT, String.valueOf(limit));
        }
