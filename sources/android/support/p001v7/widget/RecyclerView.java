...
import android.support.p001v7.recyclerview.C0338R;
import android.support.p001v7.widget.AdapterHelper.UpdateOp;
import android.support.p001v7.widget.GapWorker.LayoutPrefetchRegistryImpl;
import android.support.p001v7.widget.ViewBoundsCheck.Callback;
import android.support.p001v7.widget.ViewInfoStore.ProcessCallback;
...
public class RecyclerView extends ViewGroup implements NestedScrollingChild, ScrollingView {
    ...
    static final Interpolator sQuinticInterpolator = new C00563();
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C00521();
        ...
        private final Callback mVerticalBoundCheckCallback = new C00532();
        private int mWidth;
        ...
        class C00532 implements Callback {
            C00532() {
            }
        ...
        public void setMeasuredDimensionFromChildren(int widthSpec, int heightSpec) {
            ...
            int maxX = ExploreByTouchHelper.INVALID_ID;
            int maxY = ExploreByTouchHelper.INVALID_ID;
            for (int i = 0; i < count; i++) {
        ...
        public void setMeasuredDimension(Rect childrenBounds, int wSpec, int hSpec) {
            setMeasuredDimension(LayoutManager.chooseSize(wSpec, (childrenBounds.width() + getPaddingLeft()) + getPaddingRight(), getMinimumWidth()), LayoutManager.chooseSize(hSpec, (childrenBounds.height() + getPaddingTop()) + getPaddingBottom(), getMinimumHeight()));
        }
        ...
        public boolean shouldReMeasureChild(View child, int widthSpec, int heightSpec, LayoutParams lp) {
            return (this.mMeasurementCacheEnabled && LayoutManager.isMeasurementUpToDate(child.getMeasuredWidth(), widthSpec, lp.width) && LayoutManager.isMeasurementUpToDate(child.getMeasuredHeight(), heightSpec, lp.height)) ? false : true;
        }

        /* Access modifiers changed, original: 0000 */
        public boolean shouldMeasureChild(View child, int widthSpec, int heightSpec, LayoutParams lp) {
            return (!child.isLayoutRequested() && this.mMeasurementCacheEnabled && LayoutManager.isMeasurementUpToDate(child.getWidth(), widthSpec, lp.width) && LayoutManager.isMeasurementUpToDate(child.getHeight(), heightSpec, lp.height)) ? false : true;
        }
        ...
        public void measureChildWithMargins(View child, int widthUsed, int heightUsed) {
            ...
            int widthSpec = LayoutManager.getChildMeasureSpec(getWidth(), getWidthMode(), (((getPaddingLeft() + getPaddingRight()) + lp.leftMargin) + lp.rightMargin) + (widthUsed + (insets.left + insets.right)), lp.width, canScrollHorizontally());
            int heightSpec = LayoutManager.getChildMeasureSpec(getHeight(), getHeightMode(), (((getPaddingTop() + getPaddingBottom()) + lp.topMargin) + lp.bottomMargin) + heightUsed, lp.height, canScrollVertically());
        ...
        public static int getChildMeasureSpec(int parentSize, int parentMode, int padding, int childDimension, boolean canScroll) {
            ...
            if (canScroll) {
                ...
                resultSize = size;
                resultMode = (parentMode == ExploreByTouchHelper.INVALID_ID || parentMode == 1073741824) ? ExploreByTouchHelper.INVALID_ID : 0;
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0338R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0338R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0338R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0338R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0338R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    public static abstract class SmoothScroller {
        ...
        public static class Action {
            ...
            public Action(int dx, int dy) {
                this(dx, dy, ExploreByTouchHelper.INVALID_ID, null);
            }
            ...
            public void runIfNecessary(RecyclerView recyclerView) {
                if (this.mJumpToPosition >= 0) {
                    ...
                    } else if (this.mDuration == ExploreByTouchHelper.INVALID_ID) {
    ...
    static class C00563 implements Interpolator {
        C00563() {
        }
    ...
    class C00574 implements ProcessCallback {
        C00574() {
        }
    ...
    class C00585 implements ChildHelper.Callback {
        C00585() {
        }
    ...
    class C00596 implements AdapterHelper.Callback {
        C00596() {
        }
    ...
    public final class Recycler {
        ...
        public ViewHolder tryGetViewHolderForPositionByDeadline(int position, boolean dryRun, long deadlineNs) {
            ...
            if (lp == null) {
                ...
                LayoutParams rvLayoutParams2 = (LayoutParams) RecyclerView.this.generateLayoutParams(lp);
    ...
    class ViewFlinger implements Runnable {
        ...
        public void fling(int velocityX, int velocityY) {
            ...
            this.mLastFlingY = 0;
            this.mLastFlingX = 0;
            this.mScroller.fling(0, 0, velocityX, velocityY, ExploreByTouchHelper.INVALID_ID, Integer.MAX_VALUE, ExploreByTouchHelper.INVALID_ID, Integer.MAX_VALUE);
            postOnAnimation();
        }
        ...
        private int computeScrollDuration(int dx, int dy, int vx, int vy) {
            ...
            return Math.min(duration, ActivityTrace.MAX_TRACES);
        }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C00541();
        ...
        this.mItemAnimatorRunner = new C00552();
        this.mViewInfoProcessCallback = new C00574();
        if (attrs != null) {
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, C0338R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a.getString(C0338R.styleable.RecyclerView_layoutManager);
            if (a.getInt(C0338R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
    ...
    L_0x001e:
        ...
        r8 = android.support.p001v7.widget.RecyclerView.LayoutManager.class;
    ...
    L_0x0047:
        ...
        r7 = (android.support.p001v7.widget.RecyclerView.LayoutManager) r7;	 Catch:{ ClassNotFoundException -> 0x0088, InvocationTargetException -> 0x00aa, InstantiationException -> 0x00cc, IllegalAccessException -> 0x00ee, ClassCastException -> 0x0110 }
    ...
    L_0x0110:
        ...
        throw r7;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p001v7.widget.RecyclerView.createLayoutManager(android.content.Context, java.lang.String, android.util.AttributeSet, int, int):void");
    }
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C00585());
    }

    /* Access modifiers changed, original: 0000 */
    public void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C00596());
    }
    ...
    /* JADX WARNING: Missing block: B:82:0x037a, code skipped:
    ...
    L_0x0050:
        ...
        r3 = android.support.p000v4.view.MotionEventCompat.getActionMasked(r24);
        r4 = android.support.p000v4.view.MotionEventCompat.getActionIndex(r24);
    ...
    L_0x0332:
        ...
        r0 = r0.mScrollPointerId;
        r19 = r0;
        r18 = android.support.p000v4.view.VelocityTrackerCompat.getXVelocity(r18, r19);
        r0 = r18;
        r15 = -r0;
    L_0x0345:
    ...
    L_0x0347:
        ...
        r0 = r0.mScrollPointerId;
        r19 = r0;
        r18 = android.support.p000v4.view.VelocityTrackerCompat.getYVelocity(r18, r19);
        r0 = r18;
        r0 = -r0;
        r17 = r0;
    L_0x035c:
    ...
    L_0x038f:
        ...
        goto L_0x009d;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p001v7.widget.RecyclerView.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    private void handleMissingPreInfoForChangeError(long key, ViewHolder holder, ViewHolder oldChangeViewHolder) {
        ...
        int i = 0;
        while (i < childCount) {
            ViewHolder other = RecyclerView.getChildViewHolderInt(this.mChildHelper.getChildAt(i));
    ...
    private void findMinMaxChildLayoutPositions(int[] into) {
        ...
        int maxPositionPreLayout = ExploreByTouchHelper.INVALID_ID;
        for (int i = 0; i < count; i++) {
            ViewHolder holder = RecyclerView.getChildViewHolderInt(this.mChildHelper.getChildAt(i));
            if (!holder.shouldIgnore()) {
    ...
    static RecyclerView findNestedRecyclerView(@NonNull View view) {
        ...
        for (int i = 0; i < count; i++) {
            View descendant = RecyclerView.findNestedRecyclerView(parent.getChildAt(i));
            if (descendant != null) {
                return descendant;
            }
        }
