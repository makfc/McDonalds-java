...
import android.support.p001v7.transition.ActionBarTransition;
import android.support.p001v7.view.ActionBarPolicy;
import android.support.p001v7.view.menu.ActionMenuItemView;
import android.support.p001v7.view.menu.ActionMenuItemView.PopupCallback;
import android.support.p001v7.view.menu.BaseMenuPresenter;
...
import android.support.p001v7.widget.ActionMenuView.ActionMenuChildView;
...
class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    private static class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new C03621();
        public int openSubMenuId;

        /* renamed from: android.support.v7.widget.ActionMenuPresenter$SavedState$1 */
        static class C03621 implements Creator<SavedState> {
            C03621() {
            }
