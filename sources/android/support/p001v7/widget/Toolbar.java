...
import android.support.p001v7.view.CollapsibleActionView;
...
import android.support.p001v7.widget.ActionMenuView.OnMenuItemClickListener;
...
public class Toolbar extends ViewGroup {
    ...
    class C04221 implements OnMenuItemClickListener {
        C04221() {
        }
    ...
    public static class LayoutParams extends android.support.p001v7.app.ActionBar.LayoutParams {
        int mViewType;
        ...
        public LayoutParams(LayoutParams source) {
            super((android.support.p001v7.app.ActionBar.LayoutParams) source);
            this.mViewType = 0;
            this.mViewType = source.mViewType;
        }

        public LayoutParams(android.support.p001v7.app.ActionBar.LayoutParams source) {
            super(source);
            this.mViewType = 0;
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C04251());
        int expandedMenuItemId;
        boolean isOverflowOpen;

        /* renamed from: android.support.v7.widget.Toolbar$SavedState$1 */
        static class C04251 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C04251() {
            }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenuViewItemClickListener = new C04221();
        this.mShowOverflowMenuRunnable = new C04232();
        ...
        int contentInsetStart = a.getDimensionPixelOffset(C0334R.styleable.Toolbar_contentInsetStart, ExploreByTouchHelper.INVALID_ID);
        int contentInsetEnd = a.getDimensionPixelOffset(C0334R.styleable.Toolbar_contentInsetEnd, ExploreByTouchHelper.INVALID_ID);
        ...
        this.mContentInsetStartWithNavigation = a.getDimensionPixelOffset(C0334R.styleable.Toolbar_contentInsetStartWithNavigation, ExploreByTouchHelper.INVALID_ID);
        this.mContentInsetEndWithActions = a.getDimensionPixelOffset(C0334R.styleable.Toolbar_contentInsetEndWithActions, ExploreByTouchHelper.INVALID_ID);
    ...
    public int getContentInsetStartWithNavigation() {
        if (this.mContentInsetStartWithNavigation != ExploreByTouchHelper.INVALID_ID) {
    ...
    public void setContentInsetStartWithNavigation(int insetStartWithNavigation) {
        if (insetStartWithNavigation < 0) {
            insetStartWithNavigation = ExploreByTouchHelper.INVALID_ID;
        }
    ...
    public int getContentInsetEndWithActions() {
        if (this.mContentInsetEndWithActions != ExploreByTouchHelper.INVALID_ID) {
    ...
    public void setContentInsetEndWithActions(int insetEndWithActions) {
        if (insetEndWithActions < 0) {
            insetEndWithActions = ExploreByTouchHelper.INVALID_ID;
        }
    ...
    public void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            ...
            this.mCollapseButtonView.setOnClickListener(new C04243());
        }
    }
    ...
    private void measureChildConstrained(View child, int parentWidthSpec, int widthUsed, int parentHeightSpec, int heightUsed, int heightConstraint) {
        ...
        int childWidthSpec = Toolbar.getChildMeasureSpec(parentWidthSpec, (((getPaddingLeft() + getPaddingRight()) + lp.leftMargin) + lp.rightMargin) + widthUsed, lp.width);
        int childHeightSpec = Toolbar.getChildMeasureSpec(parentHeightSpec, (((getPaddingTop() + getPaddingBottom()) + lp.topMargin) + lp.bottomMargin) + heightUsed, lp.height);
    ...
    private int measureChildCollapseMargins(View child, int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec, int heightUsed, int[] collapsingMargins) {
        ...
        child.measure(Toolbar.getChildMeasureSpec(parentWidthMeasureSpec, ((getPaddingLeft() + getPaddingRight()) + hMargins) + widthUsed, lp.width), Toolbar.getChildMeasureSpec(parentHeightMeasureSpec, (((getPaddingTop() + getPaddingBottom()) + lp.topMargin) + lp.bottomMargin) + heightUsed, lp.height));
