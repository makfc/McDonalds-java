...
import android.support.p001v7.gridlayout.C0336R;
...
public class GridLayout extends ViewGroup {
    private static final int ALIGNMENT_MODE = C0336R.styleable.GridLayout_alignmentMode;
    public static final Alignment BASELINE = new C03917();
    public static final Alignment BOTTOM = TRAILING;
    public static final Alignment CENTER = new C03896();
    private static final int COLUMN_COUNT = C0336R.styleable.GridLayout_columnCount;
    private static final int COLUMN_ORDER_PRESERVED = C0336R.styleable.GridLayout_columnOrderPreserved;
    public static final Alignment END = TRAILING;
    public static final Alignment FILL = new C03928();
    private static final Alignment LEADING = new C03863();
    ...
    static final Printer NO_PRINTER = new C03841();
    private static final int ORIENTATION = C0336R.styleable.GridLayout_orientation;
    public static final Alignment RIGHT = GridLayout.createSwitchingAlignment(END, START);
    private static final int ROW_COUNT = C0336R.styleable.GridLayout_rowCount;
    private static final int ROW_ORDER_PRESERVED = C0336R.styleable.GridLayout_rowOrderPreserved;
    public static final Alignment START = LEADING;
    public static final Alignment TOP = LEADING;
    private static final Alignment TRAILING = new C03874();
    static final Alignment UNDEFINED_ALIGNMENT = new C03852();
    private static final int USE_DEFAULT_MARGINS = C0336R.styleable.GridLayout_useDefaultMargins;
    int mAlignmentMode;
    int mDefaultGap;
    ...
    static class C03841 implements Printer {
        C03841() {
        }
    ...
    static class C03852 extends Alignment {
        C03852() {
        }
    ...
    static class C03863 extends Alignment {
        C03863() {
        }
    ...
    static class C03874 extends Alignment {
        C03874() {
        }
    ...
    static class C03896 extends Alignment {
        C03896() {
        }
    ...
    static class Bounds {
        ...
        public void reset() {
            this.before = ExploreByTouchHelper.INVALID_ID;
            this.after = ExploreByTouchHelper.INVALID_ID;
            this.flexibility = 2;
        }
    ...
    static class C03917 extends Alignment {

        /* renamed from: android.support.v7.widget.GridLayout$7$1 */
        class C03901 extends Bounds {
            private int size;
            ...
            /* Access modifiers changed, original: protected */
            public int getOffset(GridLayout gl, View c, Alignment a, int size, boolean hrz) {
    ...
    static class C03928 extends Alignment {
        C03928() {
        }
    ...
    static final class Assoc<K, V> extends ArrayList<Pair<K, V>> {
        ...
        /* renamed from: of */
        public static <K, V> Assoc<K, V> m17of(Class<K> keyType, Class<V> valueType) {
    ...
    final class Axis {
        ...
        public int definedCount = ExploreByTouchHelper.INVALID_ID;
        public int[] deltas;
        ...
        private int maxIndex = ExploreByTouchHelper.INVALID_ID;
        ...
        private int calculateMaxIndex() {
            ...
            return result == -1 ? ExploreByTouchHelper.INVALID_ID : result;
        }

        private int getMaxIndex() {
            if (this.maxIndex == ExploreByTouchHelper.INVALID_ID) {
        ...
        public void setCount(int count) {
            if (count != ExploreByTouchHelper.INVALID_ID && count < getMaxIndex()) {
        ...
        private PackedMap<Spec, Bounds> createGroupBounds() {
            Assoc<Spec, Bounds> assoc = Assoc.m17of(Spec.class, Bounds.class);
            int N = GridLayout.this.getChildCount();
            for (int i = 0; i < N; i++) {
        ...
        private PackedMap<Interval, MutableInt> createLinks(boolean min) {
            Assoc<Interval, MutableInt> result = Assoc.m17of(Interval.class, MutableInt.class);
        ...
        public void invalidateStructure() {
            this.maxIndex = ExploreByTouchHelper.INVALID_ID;
    ...
    public static class LayoutParams extends MarginLayoutParams {
        private static final int BOTTOM_MARGIN = C0336R.styleable.GridLayout_Layout_android_layout_marginBottom;
        private static final int COLUMN = C0336R.styleable.GridLayout_Layout_layout_column;
        private static final int COLUMN_SPAN = C0336R.styleable.GridLayout_Layout_layout_columnSpan;
        private static final int COLUMN_WEIGHT = C0336R.styleable.GridLayout_Layout_layout_columnWeight;
        private static final Interval DEFAULT_SPAN = new Interval(ExploreByTouchHelper.INVALID_ID, -2147483647);
        private static final int DEFAULT_SPAN_SIZE = DEFAULT_SPAN.size();
        private static final int GRAVITY = C0336R.styleable.GridLayout_Layout_layout_gravity;
        private static final int LEFT_MARGIN = C0336R.styleable.GridLayout_Layout_android_layout_marginLeft;
        private static final int MARGIN = C0336R.styleable.GridLayout_Layout_android_layout_margin;
        private static final int RIGHT_MARGIN = C0336R.styleable.GridLayout_Layout_android_layout_marginRight;
        private static final int ROW = C0336R.styleable.GridLayout_Layout_layout_row;
        private static final int ROW_SPAN = C0336R.styleable.GridLayout_Layout_layout_rowSpan;
        private static final int ROW_WEIGHT = C0336R.styleable.GridLayout_Layout_layout_rowWeight;
        private static final int TOP_MARGIN = C0336R.styleable.GridLayout_Layout_android_layout_marginTop;
        ...
        public LayoutParams(Spec rowSpec, Spec columnSpec) {
            this(-2, -2, ExploreByTouchHelper.INVALID_ID, ExploreByTouchHelper.INVALID_ID, ExploreByTouchHelper.INVALID_ID, ExploreByTouchHelper.INVALID_ID, rowSpec, columnSpec);
        }
        ...
        private void reInitSuper(Context context, AttributeSet attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0336R.styleable.GridLayout_Layout);
            try {
                int margin = a.getDimensionPixelSize(MARGIN, ExploreByTouchHelper.INVALID_ID);
        ...
        private void init(Context context, AttributeSet attrs) {
            ...
            try {
                ...
                this.columnSpec = GridLayout.spec(a.getInt(COLUMN, ExploreByTouchHelper.INVALID_ID), a.getInt(COLUMN_SPAN, DEFAULT_SPAN_SIZE), GridLayout.getAlignment(gravity, true), a.getFloat(COLUMN_WEIGHT, 0.0f));
                this.rowSpec = GridLayout.spec(a.getInt(ROW, ExploreByTouchHelper.INVALID_ID), a.getInt(ROW_SPAN, DEFAULT_SPAN_SIZE), GridLayout.getAlignment(gravity, false), a.getFloat(ROW_WEIGHT, 0.0f));
            } finally {
                a.recycle();
            }
        }
    ...
    public static class Spec {
        static final Spec UNDEFINED = GridLayout.spec(ExploreByTouchHelper.INVALID_ID);
    ...
    public GridLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mDefaultGap = context.getResources().getDimensionPixelOffset(C0336R.dimen.default_gap);
        TypedArray a = context.obtainStyledAttributes(attrs, C0336R.styleable.GridLayout);
        try {
            setRowCount(a.getInt(ROW_COUNT, ExploreByTouchHelper.INVALID_ID));
            setColumnCount(a.getInt(COLUMN_COUNT, ExploreByTouchHelper.INVALID_ID));
    ...
    public int getMargin1(View view, boolean horizontal, boolean leading) {
        ...
        return margin == ExploreByTouchHelper.INVALID_ID ? getDefaultMargin(view, lp, horizontal, leading) : margin;
    }
    ...
    private void checkLayoutParams(LayoutParams lp, boolean horizontal) {
        ...
        if (span.min != ExploreByTouchHelper.INVALID_ID && span.min < 0) {
        ...
        if (count != ExploreByTouchHelper.INVALID_ID) {
            if (span.max > count) {
    ...
    private void measureChildWithMargins2(View child, int parentWidthSpec, int parentHeightSpec, int childWidth, int childHeight) {
        child.measure(GridLayout.getChildMeasureSpec(parentWidthSpec, getTotalMargin(child, true), childWidth), GridLayout.getChildMeasureSpec(parentHeightSpec, getTotalMargin(child, false), childHeight));
    }
    ...
    public static Spec spec(int start, int size, Alignment alignment, float weight) {
        return new Spec(start != ExploreByTouchHelper.INVALID_ID, start, size, alignment, weight);
    }
