...
public class ActionBarOverlayLayout extends ViewGroup implements NestedScrollingParent, DecorContentParent {
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C03581();
        this.mRemoveActionBarHideOffset = new C03592();
        this.mAddActionBarHideOffset = new C03603();
        init(context);
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0334R.C0333id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0334R.C0333id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0334R.C0333id.action_bar));
        }
    }
    ...
    private boolean shouldHideActionBarOnFling(float velocityX, float velocityY) {
        this.mFlingEstimator.fling(0, 0, 0, (int) velocityY, 0, 0, ExploreByTouchHelper.INVALID_ID, Integer.MAX_VALUE);
