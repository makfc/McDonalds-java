...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        if (getId() == C0334R.C0333id.split_action_bar) {
            this.mIsSplit = true;
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0334R.C0333id.action_bar);
        this.mContextView = findViewById(C0334R.C0333id.action_context_bar);
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mActionBarView != null) {
            ...
            if (this.mTabContainer != null && this.mTabContainer.getVisibility() != 8 && mode != 1073741824) {
                ...
                setMeasuredDimension(getMeasuredWidth(), Math.min(getMeasuredHeightWithMargins(this.mTabContainer) + topMarginForTabs, mode == ExploreByTouchHelper.INVALID_ID ? MeasureSpec.getSize(heightMeasureSpec) : Integer.MAX_VALUE));
            }
        }
    }
