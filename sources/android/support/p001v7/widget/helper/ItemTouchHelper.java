package android.support.p001v7.widget.helper;
...
import android.support.p001v7.widget.RecyclerView.ChildDrawingOrderCallback;
...
import android.support.p001v7.widget.RecyclerView.OnChildAttachStateChangeListener;
import android.support.p001v7.widget.RecyclerView.OnItemTouchListener;
import android.support.p001v7.widget.RecyclerView.State;
import android.support.p001v7.widget.RecyclerView.ViewHolder;
import android.support.p001v7.widget.helper.ItemTouchUIUtilImpl.Gingerbread;
import android.support.p001v7.widget.helper.ItemTouchUIUtilImpl.Honeycomb;
import android.support.p001v7.widget.helper.ItemTouchUIUtilImpl.Lollipop;
...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    class C04292 implements OnItemTouchListener {
        final /* synthetic */ ItemTouchHelper this$0;
        ...
        public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent event) {
            ...
            if (action == 0) {
                ...
                if (this.this$0.mSelected == null) {
                    RecoverAnimation animation = this.this$0.findAnimation(event);
                    if (animation != null) {
                        ItemTouchHelper itemTouchHelper = this.this$0;
                        itemTouchHelper.mInitialTouchX -= animation.f18mX;
                        itemTouchHelper = this.this$0;
                        itemTouchHelper.mInitialTouchY -= animation.f19mY;
                ...
                int index = event.findPointerIndex(this.this$0.mActivePointerId);
                if (index >= 0) {
    ...
    private class RecoverAnimation implements AnimatorListenerCompat {
        ...
        public void update() {
            if (this.mStartDx == this.mTargetX) {
                this.f18mX = ViewCompat.getTranslationX(this.mViewHolder.itemView);
            } else {
                this.f18mX = this.mStartDx + (this.mFraction * (this.mTargetX - this.mStartDx));
            }
            if (this.mStartDy == this.mTargetY) {
                this.f19mY = ViewCompat.getTranslationY(this.mViewHolder.itemView);
            } else {
                this.f19mY = this.mStartDy + (this.mFraction * (this.mTargetY - this.mStartDy));
            }
        }
    ...
    class C04335 implements ChildDrawingOrderCallback {
        C04335() {
        }
    ...
    public static abstract class Callback {
        private static final Interpolator sDragScrollInterpolator = new C04341();
        private static final Interpolator sDragViewScrollCapInterpolator = new C04352();
        private static final ItemTouchUIUtil sUICallback;
        private int mCachedMaxScrollSpeed = -1;

        /* renamed from: android.support.v7.widget.helper.ItemTouchHelper$Callback$1 */
        static class C04341 implements Interpolator {
            C04341() {
            }
        ...
        static class C04352 implements Interpolator {
            C04352() {
            }
        ...
        public int convertToAbsoluteDirection(int flags, int layoutDirection) {
            ...
            return (flags | ((masked >> 1) & -3158065)) | (((masked >> 1) & 3158064) >> 2);
        }
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == -1) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0338R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
        ...
        public void onDraw(Canvas c, RecyclerView parent, ViewHolder selected, List<RecoverAnimation> recoverAnimationList, int actionState, float dX, float dY) {
            ...
            for (int i = 0; i < recoverAnimSize; i++) {
                ...
                anim.update();
                count = c.save();
                onChildDraw(c, parent, anim.mViewHolder, anim.f18mX, anim.f19mY, anim.mActionState, false);
        ...
        public void onDrawOver(Canvas c, RecyclerView parent, ViewHolder selected, List<RecoverAnimation> recoverAnimationList, int actionState, float dX, float dY) {
            ...
            for (i = 0; i < recoverAnimSize; i++) {
                ...
                count = c.save();
                onChildDrawOver(c, parent, anim.mViewHolder, anim.f18mX, anim.f19mY, anim.mActionState, false);
                c.restoreToCount(count);
            }
            if (selected != null) {
                count = c.save();
    ...
    private class ItemTouchHelperGestureListener extends SimpleOnGestureListener {
        ...
        public void onLongPress(MotionEvent e) {
            ...
            if (child != null) {
                ViewHolder vh = this.this$0.mRecyclerView.getChildViewHolder(child);
                if (vh != null && this.this$0.mCallback.hasDragFlag(this.this$0.mRecyclerView, vh) && e.getPointerId(0) == this.this$0.mActivePointerId) {
    ...
    public boolean checkSelectForSwipe(int action, MotionEvent motionEvent, int pointerIndex) {
        ...
        int swipeFlags = (MotionEventCompat.ACTION_POINTER_INDEX_MASK & this.mCallback.getAbsoluteMovementFlags(this.mRecyclerView, vh)) >> 8;
        if (swipeFlags == 0) {
            return false;
        }
    ...
    public View findChildView(MotionEvent event) {
        ...
        if (this.mSelected != null) {
            ...
            if (ItemTouchHelper.hitTest(selectedView, x, y, this.mSelectedStartX + this.mDx, this.mSelectedStartY + this.mDy)) {
                return selectedView;
            }
        }
        for (int i = this.mRecoverAnimations.size() - 1; i >= 0; i--) {
            ...
            if (ItemTouchHelper.hitTest(view, x, y, anim.f18mX, anim.f19mY)) {
                return view;
            }
        }
    ...
    private int swipeIfNecessary(ViewHolder viewHolder) {
        ...
        int flags = (this.mCallback.convertToAbsoluteDirection(originalMovementFlags, ViewCompat.getLayoutDirection(this.mRecyclerView)) & MotionEventCompat.ACTION_POINTER_INDEX_MASK) >> 8;
        if (flags == 0) {
            return 0;
        }
        int originalFlags = (originalMovementFlags & MotionEventCompat.ACTION_POINTER_INDEX_MASK) >> 8;
        int swipeDir;
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C04335();
            }
