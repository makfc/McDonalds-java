...
import android.support.p001v7.widget.ActivityChooserModel.ActivityChooserModelClient;
...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C03631 extends DataSetObserver {
        C03631() {
        }
    ...
    class C03664 extends DataSetObserver {
        C03664() {
        }
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            switch (getItemViewType(position)) {
                case 0:
                    if (convertView == null || convertView.getId() != C0334R.C0333id.list_item) {
                    ...
                    ((ImageView) convertView.findViewById(C0334R.C0333id.icon)).setImageDrawable(activity.loadIcon(packageManager));
                    ((TextView) convertView.findViewById(C0334R.C0333id.title)).setText(activity.loadLabel(packageManager));
                ...
                case 1:
                    if (convertView == null || convertView.getId() != 1) {
                        convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0334R.layout.abc_activity_chooser_view_list_item, parent, false);
                        convertView.setId(1);
                        ((TextView) convertView.findViewById(C0334R.C0333id.title)).setText(ActivityChooserView.this.getContext().getString(C0334R.string.abc_activity_chooser_view_see_all));
                    }
                    return convertView;
                default:
                    throw new IllegalArgumentException();
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mModelDataSetObserver = new C03631();
        this.mOnGlobalLayoutListener = new C03642();
        ...
        this.mActivityChooserContent = (LinearLayoutCompat) findViewById(C0334R.C0333id.activity_chooser_view_content);
        this.mActivityChooserContentBackground = this.mActivityChooserContent.getBackground();
        this.mDefaultActivityButton = (FrameLayout) findViewById(C0334R.C0333id.default_activity_button);
        this.mDefaultActivityButton.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = (ImageView) this.mDefaultActivityButton.findViewById(C0334R.C0333id.image);
        FrameLayout expandButton = (FrameLayout) findViewById(C0334R.C0333id.expand_activities_button);
        ...
        this.mExpandActivityOverflowButtonImage = (ImageView) expandButton.findViewById(C0334R.C0333id.image);
        ...
        this.mAdapter.registerDataSetObserver(new C03664());
