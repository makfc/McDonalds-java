...
import android.support.p001v7.widget.helper.ItemTouchHelper.ViewDropHandler;
...
public class LinearLayoutManager extends LayoutManager implements ScrollVectorProvider, ViewDropHandler {
    ...
    private boolean updateAnchorFromPendingData(State state, AnchorInfo anchorInfo) {
        ...
        if (this.mPendingSavedState != null && this.mPendingSavedState.hasValidAnchor()) {
            ...
            return true;
        } else if (this.mPendingScrollPositionOffset == ExploreByTouchHelper.INVALID_ID) {
    ...
    private void updateLayoutStateToFillEnd(int itemPosition, int offset) {
        ...
        this.mLayoutState.mScrollingOffset = ExploreByTouchHelper.INVALID_ID;
    }
    ...
    public int fill(Recycler recycler, LayoutState layoutState, State state, boolean stopOnFocusable) {
        ...
        if (layoutState.mScrollingOffset != ExploreByTouchHelper.INVALID_ID) {
