...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C040510 implements OnItemClickListener {
        C040510() {
        }
    ...
    /* renamed from: android.support.v7.widget.SearchView$11 */
    class C040611 implements OnItemSelectedListener {
        C040611() {
        }
    ...
    /* renamed from: android.support.v7.widget.SearchView$12 */
    class C040712 implements TextWatcher {
        C040712() {
        }
    ...
    class C04114 implements OnFocusChangeListener {
        C04114() {
        }
    ...
    class C04125 implements OnLayoutChangeListener {
        C04125() {
        }
    ...
    class C04136 implements OnGlobalLayoutListener {
        C04136() {
        }
    ...
    class C04158 implements OnKeyListener {
        C04158() {
        }
    ...
    class C04169 implements OnEditorActionListener {
        C04169() {
        }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mShowImeRunnable = new C04081();
        this.mUpdateDrawableStateRunnable = new C04092();
        this.mReleaseCursorRunnable = new C04103();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C04147();
        this.mTextKeyListener = new C04158();
        this.mOnEditorActionListener = new C04169();
        this.mOnItemClickListener = new C040510();
        this.mOnItemSelectedListener = new C040611();
        this.mTextWatcher = new C040712();
        ...
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0334R.C0333id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0334R.C0333id.search_edit_frame);
        this.mSearchPlate = findViewById(C0334R.C0333id.search_plate);
        this.mSubmitArea = findViewById(C0334R.C0333id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0334R.C0333id.search_button);
        this.mGoButton = (ImageView) findViewById(C0334R.C0333id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0334R.C0333id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0334R.C0333id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0334R.C0333id.search_mag_icon);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C04114());
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C04125());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C04136());
    }
