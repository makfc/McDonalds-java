...
public class ActionBarContextView extends AbsActionBarView {
    ...
    private void initTitle() {
        ...
        if (this.mTitleLayout == null) {
            ...
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0334R.C0333id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0334R.C0333id.action_bar_subtitle);
    ...
    public void initForMode(final ActionMode mode) {
        ...
        this.mClose.findViewById(C0334R.C0333id.action_mode_close_button).setOnClickListener(new OnClickListener() {
