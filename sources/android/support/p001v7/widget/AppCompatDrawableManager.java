...
public final class AppCompatDrawableManager {
    private static final int[] COLORFILTER_COLOR_BACKGROUND_MULTIPLY = new int[]{C0334R.C0332drawable.abc_popup_background_mtrl_mult, C0334R.C0332drawable.abc_cab_background_internal_bg, C0334R.C0332drawable.abc_menu_hardkey_panel_mtrl_mult};
    private static final int[] COLORFILTER_COLOR_CONTROL_ACTIVATED = new int[]{C0334R.C0332drawable.abc_textfield_activated_mtrl_alpha, C0334R.C0332drawable.abc_textfield_search_activated_mtrl_alpha, C0334R.C0332drawable.abc_cab_background_top_mtrl_alpha, C0334R.C0332drawable.abc_text_cursor_material, C0334R.C0332drawable.abc_text_select_handle_left_mtrl_dark, C0334R.C0332drawable.abc_text_select_handle_middle_mtrl_dark, C0334R.C0332drawable.abc_text_select_handle_right_mtrl_dark, C0334R.C0332drawable.abc_text_select_handle_left_mtrl_light, C0334R.C0332drawable.abc_text_select_handle_middle_mtrl_light, C0334R.C0332drawable.abc_text_select_handle_right_mtrl_light};
    private static final int[] COLORFILTER_TINT_COLOR_CONTROL_NORMAL = new int[]{C0334R.C0332drawable.abc_textfield_search_default_mtrl_alpha, C0334R.C0332drawable.abc_textfield_default_mtrl_alpha, C0334R.C0332drawable.abc_ab_share_pack_mtrl_alpha};
    private static final ColorFilterLruCache COLOR_FILTER_CACHE = new ColorFilterLruCache(6);
    private static final Mode DEFAULT_MODE = Mode.SRC_IN;
    private static AppCompatDrawableManager INSTANCE;
    private static final int[] TINT_CHECKABLE_BUTTON_LIST = new int[]{C0334R.C0332drawable.abc_btn_check_material, C0334R.C0332drawable.abc_btn_radio_material};
    private static final int[] TINT_COLOR_CONTROL_NORMAL = new int[]{C0334R.C0332drawable.abc_ic_commit_search_api_mtrl_alpha, C0334R.C0332drawable.abc_seekbar_tick_mark_material, C0334R.C0332drawable.abc_ic_menu_share_mtrl_alpha, C0334R.C0332drawable.abc_ic_menu_copy_mtrl_am_alpha, C0334R.C0332drawable.abc_ic_menu_cut_mtrl_alpha, C0334R.C0332drawable.abc_ic_menu_selectall_mtrl_alpha, C0334R.C0332drawable.abc_ic_menu_paste_mtrl_am_alpha};
    private static final int[] TINT_COLOR_CONTROL_STATE_LIST = new int[]{C0334R.C0332drawable.abc_tab_indicator_material, C0334R.C0332drawable.abc_textfield_search_material};
    ...
    private static class ColorFilterLruCache extends LruCache<Integer, PorterDuffColorFilter> {
        ...
        public PorterDuffColorFilter get(int color, Mode mode) {
            return (PorterDuffColorFilter) get(Integer.valueOf(ColorFilterLruCache.generateCacheKey(color, mode)));
        }

        /* Access modifiers changed, original: 0000 */
        public PorterDuffColorFilter put(int color, Mode mode, PorterDuffColorFilter filter) {
            return (PorterDuffColorFilter) put(Integer.valueOf(ColorFilterLruCache.generateCacheKey(color, mode)), filter);
        }
    ...
    private Drawable createDrawableIfNeeded(@NonNull Context context, @DrawableRes int resId) {
        ...
        if (resId == C0334R.C0332drawable.abc_cab_background_top_material) {
            dr = new LayerDrawable(new Drawable[]{getDrawable(context, C0334R.C0332drawable.abc_cab_background_internal_bg), getDrawable(context, C0334R.C0332drawable.abc_cab_background_top_mtrl_alpha)});
        }
        if (dr != null) {
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int resId, boolean failIfNotKnown, @NonNull Drawable drawable) {
        ...
        if (tintList != null) {
            ...
            Mode tintMode = AppCompatDrawableManager.getTintMode(resId);
            if (tintMode == null) {
                return drawable;
            }
            DrawableCompat.setTintMode(drawable, tintMode);
            return drawable;
        } else if (resId == C0334R.C0332drawable.abc_seekbar_track_material) {
            ld = (LayerDrawable) drawable;
            AppCompatDrawableManager.setPorterDuffColorFilter(ld.findDrawableByLayerId(16908288), ThemeUtils.getThemeAttrColor(context, C0334R.attr.colorControlNormal), DEFAULT_MODE);
            AppCompatDrawableManager.setPorterDuffColorFilter(ld.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0334R.attr.colorControlNormal), DEFAULT_MODE);
            AppCompatDrawableManager.setPorterDuffColorFilter(ld.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0334R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
        } else if (resId == C0334R.C0332drawable.abc_ratingbar_material || resId == C0334R.C0332drawable.abc_ratingbar_indicator_material || resId == C0334R.C0332drawable.abc_ratingbar_small_material) {
            ld = (LayerDrawable) drawable;
            AppCompatDrawableManager.setPorterDuffColorFilter(ld.findDrawableByLayerId(16908288), ThemeUtils.getDisabledThemeAttrColor(context, C0334R.attr.colorControlNormal), DEFAULT_MODE);
            AppCompatDrawableManager.setPorterDuffColorFilter(ld.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0334R.attr.colorControlActivated), DEFAULT_MODE);
            AppCompatDrawableManager.setPorterDuffColorFilter(ld.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0334R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
        } else if (AppCompatDrawableManager.tintDrawableUsingColorFilter(context, resId, drawable) || !failIfNotKnown) {
            return drawable;
        } else {
            return null;
        }
    ...
    static boolean tintDrawableUsingColorFilter(@NonNull Context context, @DrawableRes int resId, @NonNull Drawable drawable) {
        ...
        } else if (resId == C0334R.C0332drawable.abc_list_divider_mtrl_alpha) {
            colorAttr = 16842800;
            colorAttrSet = true;
            alpha = Math.round(40.8f);
        } else if (resId == C0334R.C0332drawable.abc_dialog_material_background) {
            colorAttr = 16842801;
            colorAttrSet = true;
        }
        if (!colorAttrSet) {
    ...
    static Mode getTintMode(int resId) {
        if (resId == C0334R.C0332drawable.abc_switch_thumb_material) {
    ...
    public ColorStateList getTintList(@NonNull Context context, @DrawableRes int resId) {
        ...
        if (tint == null) {
            if (resId == C0334R.C0332drawable.abc_edit_text_material) {
                tint = AppCompatResources.getColorStateList(context, C0334R.color.abc_tint_edittext);
            } else if (resId == C0334R.C0332drawable.abc_switch_track_mtrl_alpha) {
                tint = AppCompatResources.getColorStateList(context, C0334R.color.abc_tint_switch_track);
            } else if (resId == C0334R.C0332drawable.abc_switch_thumb_material) {
                tint = AppCompatResources.getColorStateList(context, C0334R.color.abc_tint_switch_thumb);
            } else if (resId == C0334R.C0332drawable.abc_btn_default_mtrl_shape) {
                tint = createDefaultButtonColorStateList(context);
            } else if (resId == C0334R.C0332drawable.abc_btn_borderless_material) {
                tint = createBorderlessButtonColorStateList(context);
            } else if (resId == C0334R.C0332drawable.abc_btn_colored_material) {
                tint = createColoredButtonColorStateList(context);
            } else if (resId == C0334R.C0332drawable.abc_spinner_mtrl_am_alpha || resId == C0334R.C0332drawable.abc_spinner_textfield_background_material) {
            ...
            } else if (resId == C0334R.C0332drawable.abc_seekbar_thumb_material) {
    ...
    static void tintDrawable(Drawable drawable, TintInfo tint, int[] state) {
        if (!DrawableUtils.canSafelyMutateDrawable(drawable) || drawable.mutate() == drawable) {
            if (tint.mHasTintList || tint.mHasTintMode) {
                drawable.setColorFilter(AppCompatDrawableManager.createTintFilter(tint.mHasTintList ? tint.mTintList : null, tint.mHasTintMode ? tint.mTintMode : DEFAULT_MODE, state));
            } else {
    ...
    private static PorterDuffColorFilter createTintFilter(ColorStateList tint, Mode tintMode, int[] state) {
        ...
        return AppCompatDrawableManager.getPorterDuffColorFilter(tint.getColorForState(state, 0), tintMode);
    }
    ...
    private static void setPorterDuffColorFilter(Drawable d, int color, Mode mode) {
        ...
        d.setColorFilter(AppCompatDrawableManager.getPorterDuffColorFilter(color, mode));
    }

    private void checkVectorDrawableSetup(@NonNull Context context) {
        if (!this.mHasCheckedVectorDrawableSetup) {
            this.mHasCheckedVectorDrawableSetup = true;
            Drawable d = getDrawable(context, C0334R.C0332drawable.abc_vector_test);
