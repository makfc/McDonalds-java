...
public class ListPopupWindow implements ShowableListMenu {
    ...
    class C03721 extends ForwardingListener {
    ...
    class C03743 implements OnItemSelectedListener {
        C03743() {
        }
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C03732();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C03743());
