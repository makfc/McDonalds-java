...
public class SwitchCompat extends CompoundButton {
            ...
            case 2:
                switch (this.mTouchMode) {
                    ...
                    case 2:
                        ...
                        float newPos = SwitchCompat.constrain(this.mThumbPosition + dPos, 0.0f, 1.0f);
    ...
    public int[] onCreateDrawableState(int extraSpace) {
        ...
        if (isChecked()) {
            SwitchCompat.mergeDrawableStates(drawableState, CHECKED_STATE_SET);
        }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        if (VERSION.SDK_INT >= 14) {
            ...
            if (!TextUtils.isEmpty(switchText)) {
                ...
                newText.append(oldText).append(SafeJsonPrimitive.NULL_CHAR).append(switchText);
