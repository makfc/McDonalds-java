            ...
            for (i = 0; i < count; i++) {
                ...
                if (child.getVisibility() != 8) {
                    ...
                    if (childExtra > 0.0f) {
                        ...
                        delta -= share;
                        int childWidthMeasureSpec = LinearLayoutCompat.getChildMeasureSpec(widthMeasureSpec, ((getPaddingLeft() + getPaddingRight()) + lp.leftMargin) + lp.rightMargin, lp.width);
            ...
            for (i2 = 0; i2 < count; i2++) {
                ...
                if (!(child == null || child.getVisibility() == 8)) {
                    ...
                    if (childExtra > 0.0f) {
                        ...
                        weightSum -= childExtra;
                        delta -= share;
                        int childHeightMeasureSpec = LinearLayoutCompat.getChildMeasureSpec(heightMeasureSpec, ((getPaddingTop() + getPaddingBottom()) + lp.topMargin) + lp.bottomMargin, lp.height);
