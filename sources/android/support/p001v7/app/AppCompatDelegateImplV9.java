...
import android.support.p001v7.view.StandaloneActionMode;
...
import android.support.p001v7.widget.ContentFrameLayout.OnAttachListener;
import android.support.p001v7.widget.DecorContentParent;
import android.support.p001v7.widget.FitWindowsViewGroup;
...
import android.support.p001v7.widget.VectorEnabledTintResources;
import android.support.p001v7.widget.ViewStubCompat;
import android.support.p001v7.widget.ViewUtils;
...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements LayoutInflaterFactory, Callback {
    ...
    private final Runnable mInvalidatePanelMenuRunnable = new C03161();
    ...
    class C03172 implements OnApplyWindowInsetsListener {
        C03172() {
        }
    ...
    class C03183 implements OnFitSystemWindowsListener {
        C03183() {
        }
    ...
    class C03194 implements OnAttachListener {
        C03194() {
        }
    ...
    class C03205 implements Runnable {

        /* renamed from: android.support.v7.app.AppCompatDelegateImplV9$5$1 */
        class C03211 extends ViewPropertyAnimatorListenerAdapter {
            C03211() {
            }
        ...
        public void run() {
            ...
            if (AppCompatDelegateImplV9.this.shouldAnimateActionModeView()) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C03211());
                return;
            }
            ViewCompat.setAlpha(AppCompatDelegateImplV9.this.mActionModeView, 1.0f);
            AppCompatDelegateImplV9.this.mActionModeView.setVisibility(0);
    ...
    class C03226 extends ViewPropertyAnimatorListenerAdapter {
        C03226() {
        }
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        class C03231 extends ViewPropertyAnimatorListenerAdapter {
            C03231() {
            }
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImplV9.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C03231());
            }
    ...
    protected static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C03241());
            int featureId;
            boolean isOpen;
            Bundle menuState;

            /* renamed from: android.support.v7.app.AppCompatDelegateImplV9$PanelFeatureState$SavedState$1 */
            static class C03241 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C03241() {
                }
        ...
        if (a.hasValue(C0334R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(subDecor, new C03172());
                } else {
                    ((FitWindowsViewGroup) subDecor).setOnFitSystemWindowsListener(new C03183());
                }
                ...
                this.mDecorContentParent = (DecorContentParent) subDecor.findViewById(C0334R.C0333id.decor_content_parent);
            ...
            if (this.mDecorContentParent == null) {
                this.mTitleView = (TextView) subDecor.findViewById(C0334R.C0333id.title);
            }
            ViewUtils.makeOptionalFitsSystemWindows(subDecor);
            ContentFrameLayout contentView = (ContentFrameLayout) subDecor.findViewById(C0334R.C0333id.action_bar_activity_content);
            ...
            contentView.setAttachListener(new C03194());
            return subDecor;
        }
        a.recycle();
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    this.mShowActionModePopup = new C03205();
                } else {
                    ViewStubCompat stub = (ViewStubCompat) this.mSubDecor.findViewById(C0334R.C0333id.action_mode_bar_stub);
                    if (stub != null) {
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    if (shouldAnimateActionModeView()) {
                        ...
                        this.mFadeAnim.setListener(new C03226());
                    } else {
        ...
        if (!st.isOpen && !isDestroyed()) {
            ...
            if (cb == null || cb.onMenuOpened(st.featureId, st.menu)) {
                ...
                if (wm != null && preparePanel(st, event)) {
                    ...
                    st.isHandled = false;
                    WindowManager.LayoutParams lp2 = new WindowManager.LayoutParams(width, -2, st.f13x, st.f14y, 1002, 8519680, -3);
