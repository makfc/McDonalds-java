...
class AlertController {
    ...
    private final OnClickListener mButtonHandler = new C03061();
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController dialog) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                ListAdapter c03122 = new CursorAdapter(this.mContext, this.mCursor, false) {
    ...
    static boolean canTextInput(View v) {
        ...
        while (i > 0) {
            i--;
            if (AlertController.canTextInput(vg.getChildAt(i))) {
                return true;
            }
        }
        return false;
    ...
    private void setupView() {
        View spacer;
        View parentPanel = this.mWindow.findViewById(C0334R.C0333id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0334R.C0333id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0334R.C0333id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0334R.C0333id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0334R.C0333id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0334R.C0333id.topPanel);
        View customContentPanel = customPanel.findViewById(C0334R.C0333id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0334R.C0333id.buttonPanel);
        ...
        if (!(hasButtonPanel || contentPanel == null)) {
            spacer = contentPanel.findViewById(C0334R.C0333id.textSpacerNoButtons);
            if (spacer != null) {
        ...
        if (hasTopPanel) {
            ...
            if (!((this.mMessage == null && this.mListView == null && !hasCustomPanel) || hasCustomPanel)) {
                divider = topPanel.findViewById(C0334R.C0333id.titleDividerNoCustom);
            }
            if (divider != null) {
                divider.setVisibility(0);
            }
        } else if (contentPanel != null) {
            spacer = contentPanel.findViewById(C0334R.C0333id.textSpacerNoTitle);
            if (spacer != null) {
                spacer.setVisibility(0);
            }
        }
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0334R.C0333id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0334R.C0333id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0334R.C0333id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        ...
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0334R.C0333id.title_template).setVisibility(8);
            return;
        }
        ...
        if (hasTextTitle && this.mShowTitle) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C0334R.C0333id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0334R.C0333id.scrollView);
