...
class TransportMediatorJellybeanMR2 {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C02264();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final OnGetPlaybackPositionListener mGetPlaybackPositionListener = new C02275();
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C02253();
    PendingIntent mPendingIntent;
    int mPlayState = 0;
    final OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new C02286();
    final String mReceiverAction;
    final IntentFilter mReceiverFilter;
    RemoteControlClient mRemoteControl;
    final View mTargetView;
    final TransportMediatorCallback mTransportCallback;
    final OnWindowAttachListener mWindowAttachListener = new C02231();
    final OnWindowFocusChangeListener mWindowFocusListener = new C02242();

    /* renamed from: android.support.v4.media.TransportMediatorJellybeanMR2$1 */
    class C02231 implements OnWindowAttachListener {
        C02231() {
        }
    ...
    class C02242 implements OnWindowFocusChangeListener {
        C02242() {
        }
    ...
    class C02253 extends BroadcastReceiver {
        C02253() {
        }
    ...
    class C02264 implements OnAudioFocusChangeListener {
        C02264() {
        }
    ...
    class C02275 implements OnGetPlaybackPositionListener {
        C02275() {
        }
    ...
    class C02286 implements OnPlaybackPositionUpdateListener {
        C02286() {
        }
