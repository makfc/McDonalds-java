...
public final class RatingCompat implements Parcelable {
    public static final Creator<RatingCompat> CREATOR = new C02201();
    ...
    static class C02201 implements Creator<RatingCompat> {
        C02201() {
        }
    ...
    public static RatingCompat fromRating(Object ratingObj) {
        ...
        if (ratingObj != null && VERSION.SDK_INT >= 19) {
            ...
            if (RatingCompatKitkat.isRated(ratingObj)) {
                switch (ratingStyle) {
                    case 1:
                        rating = RatingCompat.newHeartRating(RatingCompatKitkat.hasHeart(ratingObj));
                        break;
                    case 2:
                        rating = RatingCompat.newThumbRating(RatingCompatKitkat.isThumbUp(ratingObj));
                        break;
                    case 3:
                    case 4:
                    case 5:
                        rating = RatingCompat.newStarRating(ratingStyle, RatingCompatKitkat.getStarRating(ratingObj));
                        break;
                    case 6:
                        rating = RatingCompat.newPercentageRating(RatingCompatKitkat.getPercentRating(ratingObj));
                        break;
                }
            }
    ...
    L_0x001a:
        r0 = r2.hasHeart();
        r0 = android.support.p000v4.media.RatingCompatKitkat.newHeartRating(r0);
        r2.mRatingObj = r0;
    L_0x0024:
        r0 = r2.mRatingObj;
        goto L_0x000c;
    L_0x0027:
        r0 = r2.isThumbUp();
        r0 = android.support.p000v4.media.RatingCompatKitkat.newThumbRating(r0);
        r2.mRatingObj = r0;
        goto L_0x0024;
    L_0x0032:
        r0 = r2.mRatingStyle;
        r1 = r2.getStarRating();
        r0 = android.support.p000v4.media.RatingCompatKitkat.newStarRating(r0, r1);
        r2.mRatingObj = r0;
        goto L_0x0024;
    L_0x003f:
        r0 = r2.getPercentRating();
        r0 = android.support.p000v4.media.RatingCompatKitkat.newPercentageRating(r0);
        r2.mRatingObj = r0;
        goto L_0x0018;
    L_0x004a:
        r0 = r2.mRatingStyle;
        r0 = android.support.p000v4.media.RatingCompatKitkat.newUnratedRating(r0);
        r2.mRatingObj = r0;
        goto L_0x0024;
        */
