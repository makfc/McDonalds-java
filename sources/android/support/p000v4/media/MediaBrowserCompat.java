...
public final class MediaBrowserCompat {
    ...
    public static class ConnectionCallback {
        ...
        private class StubApi21 implements android.support.p000v4.media.MediaBrowserCompatApi21.ConnectionCallback {
            StubApi21() {
            }
    ...
    public static abstract class ItemCallback {
        ...
        private class StubApi23 implements android.support.p000v4.media.MediaBrowserCompatApi23.ItemCallback {
            StubApi23() {
            }
    ...
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public void onServiceConnected(Messenger callback, String root, Token session, Bundle extra) {
            ...
            if (this.mState != 1) {
                Log.w(MediaBrowserCompat.TAG, "onConnect from service while mState=" + MediaBrowserImplBase.getStateLabel(this.mState) + "... ignoring");
                return;
            }
            this.mRootId = root;
        ...
        public void dump() {
            ...
            Log.d(MediaBrowserCompat.TAG, "  mState=" + MediaBrowserImplBase.getStateLabel(this.mState));
    ...
    public static class MediaItem implements Parcelable {
        public static final Creator<MediaItem> CREATOR = new C02001();
        ...
        static class C02001 implements Creator<MediaItem> {
            C02001() {
            }
        ...
        public static MediaItem fromMediaItem(Object itemObj) {
            ...
            return new MediaItem(MediaDescriptionCompat.fromMediaDescription(android.support.p000v4.media.MediaBrowserCompatApi21.MediaItem.getDescription(itemObj)), android.support.p000v4.media.MediaBrowserCompatApi21.MediaItem.getFlags(itemObj));
        }
    ...
    public static abstract class SubscriptionCallback {
        ...
        private class StubApi21 implements android.support.p000v4.media.MediaBrowserCompatApi21.SubscriptionCallback {
            StubApi21() {
            }
        ...
        private class StubApi24 extends StubApi21 implements android.support.p000v4.media.MediaBrowserCompatApi24.SubscriptionCallback {
            StubApi24() {
                super();
            }
