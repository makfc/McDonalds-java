...
class MediaControllerCompatApi21 {
    ...
    public static class PlaybackInfo {
        ...
        public static int getLegacyAudioStream(Object volumeInfoObj) {
            return PlaybackInfo.toLegacyStreamType(PlaybackInfo.getAudioAttributes(volumeInfoObj));
        }
    ...
    public static void registerCallback(Object controllerObj, Object callbackObj, Handler handler) {
        ((MediaController) controllerObj).registerCallback((Callback) callbackObj, handler);
    }

    public static void unregisterCallback(Object controllerObj, Object callbackObj) {
        ((MediaController) controllerObj).unregisterCallback((Callback) callbackObj);
    }
