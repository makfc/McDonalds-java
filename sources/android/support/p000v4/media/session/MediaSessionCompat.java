...
import android.support.p000v4.media.VolumeProviderCompat.Callback;
...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        private class StubApi21 implements android.support.p000v4.media.session.MediaSessionCompatApi21.Callback {
            StubApi21() {
            }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        class C02382 implements MediaSessionCompatApi19.Callback {
            C02382() {
            }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            MediaSessionCompatApi19.Callback cb19 = new C02382();
            if (VERSION.SDK_INT >= 18) {
    ...
    public static final class QueueItem implements Parcelable {
        public static final Creator<QueueItem> CREATOR = new C02391();
        ...
        static class C02391 implements Creator<QueueItem> {
            C02391() {
            }
        ...
        public Object getQueueItem() {
            ...
            this.mItem = android.support.p000v4.media.session.MediaSessionCompatApi21.QueueItem.createItem(this.mDescription.getMediaDescription(), this.mId);
            return this.mItem;
        }

        @Deprecated
        public static QueueItem obtain(Object queueItem) {
            return QueueItem.fromQueueItem(queueItem);
        }
        ...
        public static QueueItem fromQueueItem(Object queueItem) {
            ...
            return new QueueItem(queueItem, MediaDescriptionCompat.fromMediaDescription(android.support.p000v4.media.session.MediaSessionCompatApi21.QueueItem.getDescription(queueItem)), android.support.p000v4.media.session.MediaSessionCompatApi21.QueueItem.getQueueId(queueItem));
        }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        public static final Creator<ResultReceiverWrapper> CREATOR = new C02401();
        private ResultReceiver mResultReceiver;

        /* renamed from: android.support.v4.media.session.MediaSessionCompat$ResultReceiverWrapper$1 */
        static class C02401 implements Creator<ResultReceiverWrapper> {
            C02401() {
            }
    ...
    public static final class Token implements Parcelable {
        public static final Creator<Token> CREATOR = new C02411();
        private final Object mInner;

        /* renamed from: android.support.v4.media.session.MediaSessionCompat$Token$1 */
        static class C02411 implements Creator<Token> {
            C02411() {
            }
