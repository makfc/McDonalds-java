...
import android.support.p000v4.media.session.MediaControllerCompatApi21.PlaybackInfo;
import android.support.p000v4.media.session.MediaControllerCompatApi21.TransportControls;
...
public final class MediaControllerCompat {
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public PlaybackInfo getPlaybackInfo() {
            ...
            return volumeInfoObj != null ? new PlaybackInfo(PlaybackInfo.getPlaybackType(volumeInfoObj), PlaybackInfo.getLegacyAudioStream(volumeInfoObj), PlaybackInfo.getVolumeControl(volumeInfoObj), PlaybackInfo.getMaxVolume(volumeInfoObj), PlaybackInfo.getCurrentVolume(volumeInfoObj)) : null;
        }
