...
public class TransportMediator extends TransportController {
    ...
    class C02211 implements TransportMediatorCallback {
        C02211() {
        }
    ...
    class C02222 implements Callback {
        C02222() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C02211();
        this.mKeyEventCallback = new C02222();
