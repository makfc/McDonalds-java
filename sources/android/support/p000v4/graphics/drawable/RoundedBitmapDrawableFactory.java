...
public final class RoundedBitmapDrawableFactory {
    ...
    public static RoundedBitmapDrawable create(Resources res, String filepath) {
        RoundedBitmapDrawable drawable = RoundedBitmapDrawableFactory.create(res, BitmapFactory.decodeFile(filepath));
    ...
    public static RoundedBitmapDrawable create(Resources res, InputStream is) {
        RoundedBitmapDrawable drawable = RoundedBitmapDrawableFactory.create(res, BitmapFactory.decodeStream(is));
        if (drawable.getBitmap() == null) {
