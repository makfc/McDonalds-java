...
public class AccessibilityWindowInfoCompat {
    ...
    public static AccessibilityWindowInfoCompat obtain(AccessibilityWindowInfoCompat info) {
        return info == null ? null : AccessibilityWindowInfoCompat.wrapNonNullInstance(IMPL.obtain(info.mInfo));
    }
    ...
    public String toString() {
        ...
        builder.append(", type=").append(AccessibilityWindowInfoCompat.typeToString(getType()));
