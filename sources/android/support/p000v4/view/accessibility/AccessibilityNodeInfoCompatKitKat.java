...
class AccessibilityNodeInfoCompatKitKat {
    ...
    public static void setRangeInfo(Object info, Object rangeInfo) {
        ((AccessibilityNodeInfo) info).setRangeInfo((RangeInfo) rangeInfo);
    }
    ...
    private static long getTraits(Object info) {
        return AccessibilityNodeInfoCompatKitKat.getExtras(info).getLong(TRAITS_KEY, -1);
    }

    private static void setTrait(Object info, long trait) {
        Bundle extras = AccessibilityNodeInfoCompatKitKat.getExtras(info);
    ...
    public static CharSequence getRoleDescription(Object info) {
        return AccessibilityNodeInfoCompatKitKat.getExtras(info).getCharSequence(ROLE_DESCRIPTION_KEY);
    }

    public static void setRoleDescription(Object info, CharSequence roleDescription) {
        AccessibilityNodeInfoCompatKitKat.getExtras(info).putCharSequence(ROLE_DESCRIPTION_KEY, roleDescription);
    }
