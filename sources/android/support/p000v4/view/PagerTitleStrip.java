...
public class PagerTitleStrip extends ViewGroup {
    ...
    public void setNonPrimaryAlpha(@FloatRange float alpha) {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int childHeightSpec = PagerTitleStrip.getChildMeasureSpec(heightMeasureSpec, heightPadding, -2);
        int widthSize = MeasureSpec.getSize(widthMeasureSpec);
        int childWidthSpec = PagerTitleStrip.getChildMeasureSpec(widthMeasureSpec, (int) (((float) widthSize) * 0.2f), -2);
        this.mPrevText.measure(childWidthSpec, childHeightSpec);
        this.mCurrText.measure(childWidthSpec, childHeightSpec);
        this.mNextText.measure(childWidthSpec, childHeightSpec);
