...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C02651();
    ...
    private static final Interpolator sInterpolator = new C02662();
    ...
    private final Runnable mEndScrollRunnable = new C02673();
    ...
    static class C02651 implements Comparator<ItemInfo> {
        C02651() {
        }
    ...
    static class C02662 implements Interpolator {
        C02662() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C02691());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        /* renamed from: android.support.v4.view.ViewPager$SavedState$1 */
        static class C02691 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02691() {
            }
