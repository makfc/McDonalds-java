...
import android.support.p000v4.view.LayoutInflaterCompatBase.FactoryWrapper;
...
class LayoutInflaterCompatHC {
    ...
    static void setFactory(LayoutInflater inflater, LayoutInflaterFactory factory) {
        ...
        if (f instanceof Factory2) {
            LayoutInflaterCompatHC.forceSetFactory2(inflater, (Factory2) f);
        } else {
            LayoutInflaterCompatHC.forceSetFactory2(inflater, factory2);
        }
    }
