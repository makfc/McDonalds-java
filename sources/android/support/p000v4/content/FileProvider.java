...
public class FileProvider extends ContentProvider {
    ...
    public void attachInfo(Context context, ProviderInfo info) {
        ...
        if (info.exported) {
            ...
            this.mStrategy = FileProvider.getPathStrategy(context, info.authority);
        } else {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        cols = FileProvider.copyOf(cols, i2);
        values = FileProvider.copyOf(values, i2);
    ...
    public ParcelFileDescriptor openFile(Uri uri, String mode) throws FileNotFoundException {
        return ParcelFileDescriptor.open(this.mStrategy.getFileForUri(uri), FileProvider.modeToMode(mode));
    }
    ...
    private static PathStrategy getPathStrategy(Context context, String authority) {
        ...
        synchronized (sCache) {
            ...
            if (strat == null) {
                try {
                    strat = FileProvider.parsePathStrategy(context, authority);
