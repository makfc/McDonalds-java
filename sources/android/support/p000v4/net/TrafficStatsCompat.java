...
public final class TrafficStatsCompat {
    ...
    static class BaseTrafficStatsCompatImpl implements TrafficStatsCompatImpl {
        private ThreadLocal<SocketTags> mThreadSocketTags = new C02451();

        /* renamed from: android.support.v4.net.TrafficStatsCompat$BaseTrafficStatsCompatImpl$1 */
        class C02451 extends ThreadLocal<SocketTags> {
            C02451() {
            }
    ...
    static {
        if (DCSProfile.INDICATOR_FALSE.equals(VERSION.CODENAME)) {
