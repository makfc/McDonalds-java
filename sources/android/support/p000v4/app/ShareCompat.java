...
public final class ShareCompat {
    ...
    static class ShareCompatImplBase implements ShareCompatImpl {
        ...
        public String escapeHtml(CharSequence text) {
            ...
            ShareCompatImplBase.withinStyle(out, text, 0, text.length());
            return out.toString();
        }
        ...
        private static void withinStyle(StringBuilder out, CharSequence text, int start, int end) {
            ...
            while (i < end) {
                ...
                if (c == '<') {
                    ...
                    out.append("&amp;");
                } else if (c > '~' || c < SafeJsonPrimitive.NULL_CHAR) {
                    out.append("&#" + c + ";");
                } else if (c == SafeJsonPrimitive.NULL_CHAR) {
                    while (i + 1 < end && text.charAt(i + 1) == SafeJsonPrimitive.NULL_CHAR) {
                        out.append("&nbsp;");
                        i++;
                    }
