...
import android.support.p000v4.app.NotificationCompatJellybean.Builder;
...
public class NotificationCompat {
    ...
    public static class Action extends android.support.p000v4.app.NotificationCompatBase.Action {
        @RestrictTo
        public static final Factory FACTORY = new C01751();
        ...
        static class C01751 implements Factory {
            C01751() {
            }
    ...
    public static class Builder {
        ...
        public Builder setSubText(CharSequence text) {
            this.mSubText = Builder.limitCharSequenceLength(text);
            return this;
        }
        ...
        public Builder setContentInfo(CharSequence info) {
            this.mContentInfo = Builder.limitCharSequenceLength(info);
            return this;
        }
    ...
    public static final class CarExtender implements Extender {
        ...
        public static class UnreadConversation extends android.support.p000v4.app.NotificationCompatBase.UnreadConversation {
            static final android.support.p000v4.app.NotificationCompatBase.UnreadConversation.Factory FACTORY = new C01761();
            ...
            static class C01761 implements android.support.p000v4.app.NotificationCompatBase.UnreadConversation.Factory {
                C01761() {
                }
            ...
            static List<Message> getMessagesFromBundleArray(Parcelable[] bundles) {
                ...
                for (int i = 0; i < bundles.length; i++) {
                    if (bundles[i] instanceof Bundle) {
                        Message message = Message.getMessageFromBundle((Bundle) bundles[i]);
                        if (message != null) {
    ...
    static class NotificationCompatImplJellybean extends NotificationCompatImplBase {
        ...
        public Notification build(Builder b, BuilderExtender extender) {
            Builder builder = new Builder(b.mContext, b.mNotification, b.resolveTitle(), b.resolveText(), b.mContentInfo, b.mTickerView, b.mNumber, b.mContentIntent, b.mFullScreenIntent, b.mLargeIcon, b.mProgressMax, b.mProgress, b.mProgressIndeterminate, b.mUseChronometer, b.mPriority, b.mSubText, b.mLocalOnly, b.mExtras, b.mGroupKey, b.mGroupSummary, b.mSortKey, b.mContentView, b.mBigContentView);
    ...
    static void addStyleToBuilderApi24(NotificationBuilderWithBuilderAccessor builder, Style style) {
        ...
        NotificationCompat.addStyleToBuilderJellybean(builder, style);
    }
