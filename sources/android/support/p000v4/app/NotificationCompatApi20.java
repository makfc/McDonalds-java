...
class NotificationCompatApi20 {
    ...
    public static class Builder implements NotificationBuilderWithActions, NotificationBuilderWithBuilderAccessor {
        ...
        public Notification build() {
            this.f2b.setExtras(this.mExtras);
            Notification notification = this.f2b.build();
    ...
    public static void addAction(Builder b, Action action) {
        Bundle actionExtras;
    ...
    public static Action getAction(Notification notif, int actionIndex, Factory actionFactory, RemoteInputCompatBase.RemoteInput.Factory remoteInputFactory) {
        return NotificationCompatApi20.getActionCompatFromAction(notif.actions[actionIndex], actionFactory, remoteInputFactory);
    }
    ...
    public static Action[] getActionsFromParcelableArrayList(ArrayList<Parcelable> parcelables, Factory actionFactory, RemoteInputCompatBase.RemoteInput.Factory remoteInputFactory) {
        ...
        for (int i = 0; i < actions.length; i++) {
            actions[i] = NotificationCompatApi20.getActionCompatFromAction((Notification.Action) parcelables.get(i), actionFactory, remoteInputFactory);
        }
        return actions;
    }
    ...
    public static ArrayList<Parcelable> getParcelableArrayListForActions(Action[] actions) {
        ...
        for (Action action : actions) {
            parcelables.add(NotificationCompatApi20.getActionFromActionCompat(action));
        }
        return parcelables;
    }
