...
final class BackStackState implements Parcelable {
    public static final Creator<BackStackState> CREATOR = new C01541();
    ...
    static class C01541 implements Creator<BackStackState> {
        C01541() {
        }
    ...
    public BackStackState(BackStackRecord bse) {
        ...
        if (bse.mAddToBackStack) {
            ...
            for (int opNum = 0; opNum < numOps; opNum++) {
                C0153Op op = (C0153Op) bse.mOps.get(opNum);
                int i = pos + 1;
