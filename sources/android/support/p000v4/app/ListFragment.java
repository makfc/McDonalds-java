...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C01742();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C01731();
    ...
    class C01742 implements OnItemClickListener {
        C01742() {
        }
