...
public class FragmentActivity extends BaseFragmentActivityJB implements OnRequestPermissionsResultCallback, RequestPermissionsRequestCodeValidator {
    ...
    final Handler mHandler = new C01551();
    ...
    private static String viewToString(View view) {
        ...
        out.append(SafeJsonPrimitive.NULL_CHAR);
    ...
    private void dumpViewHierarchy(String prefix, PrintWriter writer, View view) {
        writer.print(prefix);
        if (view == null) {
            writer.println(SafeJsonPrimitive.NULL_STRING);
            return;
        }
        writer.println(FragmentActivity.viewToString(view));
