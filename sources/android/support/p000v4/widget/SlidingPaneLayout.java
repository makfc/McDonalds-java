...
public class SlidingPaneLayout extends ViewGroup {
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C02941());
        boolean isOpen;

        /* renamed from: android.support.v4.widget.SlidingPaneLayout$SavedState$1 */
        static class C02941 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02941() {
            }
