...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C03031();
    ...
    private final Runnable mSetIdleRunnable = new C03042();
    ...
    static class C03031 implements Interpolator {
        C03031() {
        }
    ...
    public static ViewDragHelper create(ViewGroup forParent, float sensitivity, Callback cb) {
        ViewDragHelper helper = ViewDragHelper.create(forParent, cb);
    ...
    public boolean shouldInterceptTouchEvent(android.view.MotionEvent r27) {
        /*
        r26 = this;
        r4 = android.support.p000v4.view.MotionEventCompat.getActionMasked(r27);
        r5 = android.support.p000v4.view.MotionEventCompat.getActionIndex(r27);
    ...
    /* JADX WARNING: Missing block: B:45:0x0250, code skipped:
            r17 = r22.getX(r8);
     */
    public void processTouchEvent(android.view.MotionEvent r22) {
        /*
        r21 = this;
        r3 = android.support.p000v4.view.MotionEventCompat.getActionMasked(r22);
        r4 = android.support.p000v4.view.MotionEventCompat.getActionIndex(r22);
