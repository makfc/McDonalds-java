...
class ChangeBoundsPort extends TransitionPort {
    ...
    class C01371 extends TransitionListenerAdapter {
    ...
    class C01382 extends TransitionListenerAdapter {
        boolean mCanceled = false;
    ...
    class C01393 extends AnimatorListenerAdapter {
        C01393() {
        }
    ...
    private void captureValues(TransitionValues values) {
        ...
        values.values.put("android:changeBounds:windowX", Integer.valueOf(this.tempLocation[0]));
        values.values.put("android:changeBounds:windowY", Integer.valueOf(this.tempLocation[1]));
    }
    ...
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) {
        ...
        ViewGroup startParent = (ViewGroup) startValues.values.get("android:changeBounds:parent");
        ViewGroup endParent = (ViewGroup) endValues.values.get("android:changeBounds:parent");
            ...
            if (numChanges > 0) {
                ...
                if (this.mResizeClip) {
                    ...
                    if (view.getParent() instanceof ViewGroup) {
                        ...
                        addListener(new C01382());
                    }
                    anim.addListener(new C01393());
                    return anim;
                }
                pvh = new PropertyValuesHolder[numChanges];
                if (startLeft != endLeft) {
