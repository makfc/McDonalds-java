...
class FadePort extends VisibilityPort {
    ...
    private Animator createAnimation(View view, float startAlpha, float endAlpha, AnimatorListenerAdapter listener) {
        ...
        if (startAlpha != endAlpha) {
            ...
            if (DBG) {
                Log.d("Fade", "Created animator " + anim);
            }
            if (listener != null) {
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        transitionValues.values.put("android:fade:screenX", Integer.valueOf(loc[0]));
        transitionValues.values.put("android:fade:screenY", Integer.valueOf(loc[1]));
    }
    ...
    public Animator onAppear(ViewGroup sceneRoot, TransitionValues startValues, int startVisibility, TransitionValues endValues, int endVisibility) {
        ...
        if (DBG) {
            ...
            Log.d("Fade", "Fade.onAppear: startView, startVis, endView, endVis = " + startView + ", " + startVisibility + ", " + endView + ", " + endVisibility);
        }
    ...
    public Animator onDisappear(ViewGroup sceneRoot, TransitionValues startValues, int startVisibility, TransitionValues endValues, int endVisibility) {
        ...
        if (DBG) {
            Log.d("Fade", "Fade.onDisappear: startView, startVis, endView, endVis = " + startView + ", " + startVisibility + ", " + endView + ", " + endVisibility);
        }
        ...
        if (overlayView != null) {
            int screenX = ((Integer) startValues.values.get("android:fade:screenX")).intValue();
            int screenY = ((Integer) startValues.values.get("android:fade:screenY")).intValue();
            int[] loc = new int[2];
