...
abstract class VisibilityPort extends TransitionPort {
    ...
    public boolean isVisible(TransitionValues values) {
        ...
        boolean z = ((Integer) values.values.get("android:visibility:visibility")).intValue() == 0 && ((View) values.values.get("android:visibility:parent")) != null;
        return z;
    }
    ...
    private VisibilityInfo getVisibilityChangeInfo(TransitionValues startValues, TransitionValues endValues) {
        ...
        if (startValues != null) {
            visInfo.startVisibility = ((Integer) startValues.values.get("android:visibility:visibility")).intValue();
        ...
        if (endValues != null) {
            visInfo.endVisibility = ((Integer) endValues.values.get("android:visibility:visibility")).intValue();
